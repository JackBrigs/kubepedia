...
# Облачные провайдеры в sample-inventory (v2.28.1)

Заметка описывает файлы `inventory/sample/group_vars/all/<cloud>.yml` тега **v2.28.1** (commit `a20891a`). Источник истины — [[versions/v2.28.1/inventory/cloud-providers|cloud-providers.yaml]]; здесь дан человекочитаемый обзор.
...
В sample-inventory v2.28.1 присутствуют заготовки для 9 облачных провайдеров:
