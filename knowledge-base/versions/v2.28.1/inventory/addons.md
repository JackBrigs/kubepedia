...
# Sample-inventory: addons.yml (v2.28.1)

Разбор `inventory/sample/group_vars/k8s_cluster/addons.yml` (248 строк) — файла включения дополнительных компонентов кластера. Источник истины — [[versions/v2.28.1/inventory/addons|addons.yaml (справочник)]].
...
> В v2.28.1 в блоке Local Path Provisioner присутствует закомментированный пример `local_path_provisioner_image_tag: "v0.0.24"`, удалённый в v2.29.1 (там 92 переменные).
