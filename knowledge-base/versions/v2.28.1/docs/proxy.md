...
Дайджест документации по настройке прокси строго с тега `v2.28.1` (commit `a20891a`). Файлы `docs/advanced/proxy.md` и `docs/advanced/mitogen.md` идентичны версии v2.29.1.
...
- `docs/advanced/proxy.md` — https://github.com/kubernetes-sigs/kubespray/blob/v2.28.1/docs/advanced/proxy.md
- `docs/advanced/mitogen.md` — https://github.com/kubernetes-sigs/kubespray/blob/v2.28.1/docs/advanced/mitogen.md

Связанные заметки: [[versions/v2.28.1/docs/offline|Оффлайн-развёртывание и зеркала]] · [[versions/v2.28.1/variables/download|Переменные download]] · [[versions/v2.28.1/README|Срез v2.28.1]]
