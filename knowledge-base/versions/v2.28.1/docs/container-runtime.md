...
# Container runtime в v2.28.1

Дайджест документации по container runtime строго с тега `v2.28.1` (commit `a20891a`).
Выбор рантайма задаётся переменной `container_manager` (`containerd` | `crio` | `docker`).
В проекте детально индексируется **containerd**.

> Отличия от v2.29.1: (1) в `docs/CRI/containerd.md` тега v2.28.1 **ещё нет** раздела «Optional : Static Binary» и переменной `containerd_static_binary` (добавлены в v2.29.1); (2) в `docs/operations/cgroups.md` тега v2.28.1 **присутствуют** переменные резервирования для master-хостов (`kube_master_*`, `system_master_*`), которые удалены в v2.29.1. Файлы `cri-o.md`, `docker.md`, `gvisor.md`, `kata-containers.md` идентичны v2.29.1.
...
- Аутентификация в приватном реестре образов настраивается через
  ...
  подробно в [[versions/v2.28.1/docs/offline|Оффлайн-развёртывание и зеркала]].

Примечание: раздел «Static Binary» (`containerd_static_binary`) в `docs/CRI/containerd.md`
тега v2.28.1 **отсутствует** — он появился только в v2.29.1. Sandbox/pause image как
отдельная переменная в документе также не описана; параметры образа pause относятся
к переменным download — см. [[versions/v2.28.1/variables/download|Переменные download]].
...
- **Резервирование под kube-демоны на master-хостах** (только v2.28.1, удалено в
...
- **Резервирование под системные демоны на master-хостах** (только v2.28.1, удалено
...
Файл `docs/operations/cgroups.md` тега v2.28.1 сам по себе не задаёт выбор
...
в v2.28.1 переменные.

## Источники

- `docs/CRI/containerd.md` — https://github.com/kubernetes-sigs/kubespray/blob/v2.28.1/docs/CRI/containerd.md
- `docs/CRI/cri-o.md` — https://github.com/kubernetes-sigs/kubespray/blob/v2.28.1/docs/CRI/cri-o.md
- `docs/CRI/docker.md` — https://github.com/kubernetes-sigs/kubespray/blob/v2.28.1/docs/CRI/docker.md
- `docs/CRI/gvisor.md` — https://github.com/kubernetes-sigs/kubespray/blob/v2.28.1/docs/CRI/gvisor.md
- `docs/CRI/kata-containers.md` — https://github.com/kubernetes-sigs/kubespray/blob/v2.28.1/docs/CRI/kata-containers.md
- `docs/operations/cgroups.md` — https://github.com/kubernetes-sigs/kubespray/blob/v2.28.1/docs/operations/cgroups.md

Связанные заметки: [[versions/v2.28.1/variables/container-runtime|Переменные рантайма]] · [[versions/v2.28.1/variables/download|Переменные download]] · [[versions/v2.28.1/README|Срез v2.28.1]]
