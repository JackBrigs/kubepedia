...
Дайджест документации `docs/operations/etcd.md` тега v2.28.1: типы развёртывания etcd, топология и экспозиция метрик. Файл `docs/operations/etcd.md` идентичен версии v2.29.1 (изменений между тегами нет).

Связанные заметки: [[versions/v2.28.1/variables/etcd|Переменные etcd]] · [[versions/v2.28.1/ansible-tags|Ansible-теги]] · [[versions/v2.28.1/README|Срез v2.28.1]].
...
- `docs/operations/etcd.md` (v2.28.1)
