...
# Облачные провайдеры в sample-inventory (v2.28.0)

Заметка описывает файлы `inventory/sample/group_vars/all/<cloud>.yml` тега **v2.28.0** (commit `63cdf87`). Источник истины — [[versions/v2.28.0/inventory/cloud-providers|cloud-providers.yaml]]; здесь дан человекочитаемый обзор.
...
В sample-inventory v2.28.0 присутствуют заготовки для 9 облачных провайдеров:
