...
# Sample-inventory: inventory.ini (v2.28.0)

Разбор `inventory/sample/inventory.ini` — файла описания хостов и групп. Ссылка на срез: [[versions/v2.28.0/README|Срез v2.28.0]].
...
Значения переменных кластера разбираются в [[versions/v2.28.0/inventory/k8s-cluster|k8s-cluster.yaml]] и [[versions/v2.28.0/inventory/addons|addons.yaml]]. Данный файл описывает только структуру групп хостов.
