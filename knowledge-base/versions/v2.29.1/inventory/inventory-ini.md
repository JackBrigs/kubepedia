...
# Sample-inventory: inventory.ini (v2.29.1)

Разбор `inventory/sample/inventory.ini` — файла описания хостов и групп. Ссылка на срез: [[versions/v2.29.1/README|Срез v2.29.1]].
...
Значения переменных кластера разбираются в [[versions/v2.29.1/inventory/k8s-cluster|k8s-cluster.yaml]] и [[versions/v2.29.1/inventory/addons|addons.yaml]]. Данный файл описывает только структуру групп хостов.
