...
# Sample-inventory: настройки Cilium (v2.29.1)

Разбор файла `inventory/sample/group_vars/k8s_cluster/k8s-net-cilium.yml` тега
**v2.29.1** (commit `0c6a295`). Из сетевых плагинов в проекте индексируется
**только Cilium**.

Источник истины по машиночитаемым данным — [[versions/v2.29.1/inventory/cni-cilium|cni-cilium.yaml]].
Значения по умолчанию самой роли — в [[versions/v2.29.1/variables/cni|variables/cni.yaml]].
Родительский срез: [[versions/v2.29.1/README|Срез v2.29.1]].
...
[[versions/v2.29.1/variables/cni|variables/cni.yaml]].
...
Из сетевых плагинов v2.29.1 индексируется только Cilium. Следующие sample-файлы
