...
# Управление узлами и восстановление control plane в v2.29.1

Дайджест построен строго по документации тега `v2.29.1` (commit `0c6a295`): `docs/operations/nodes.md` и `docs/operations/recover-control-plane.md`. Выжимка, не дословный перевод; имена плейбуков, переменных и команд приведены точно.
...
Связанные срезы: [[versions/v2.29.1/ansible-tags|Ansible-теги запуска v2.29.1]] (reset, pre-remove, post-remove), [[versions/v2.29.1/variables/etcd|Переменные etcd v2.29.1]].

## Источники

- `docs/operations/nodes.md` (тег v2.29.1)
- `docs/operations/recover-control-plane.md` (тег v2.29.1)
