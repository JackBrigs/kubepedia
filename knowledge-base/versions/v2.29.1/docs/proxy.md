...
Дайджест документации по настройке прокси строго с тега `v2.29.1` (commit `0c6a295`).
...
- `docs/advanced/proxy.md` — https://github.com/kubernetes-sigs/kubespray/blob/v2.29.1/docs/advanced/proxy.md
- `docs/advanced/mitogen.md` — https://github.com/kubernetes-sigs/kubespray/blob/v2.29.1/docs/advanced/mitogen.md

Связанные заметки: [[versions/v2.29.1/docs/offline|Оффлайн-развёртывание и зеркала]] · [[versions/v2.29.1/variables/download|Переменные download]] · [[versions/v2.29.1/README|Срез v2.29.1]]
