...
Дайджест документации `docs/operations/etcd.md` тега v2.29.1: типы развёртывания etcd, топология и экспозиция метрик.

Связанные заметки: [[versions/v2.29.1/variables/etcd|Переменные etcd]] · [[versions/v2.29.1/ansible-tags|Ansible-теги]] · [[versions/v2.29.1/README|Срез v2.29.1]].
...
- `docs/operations/etcd.md` (v2.29.1)
