...
# Sample-inventory: addons.yml (v2.29.0)

Разбор `inventory/sample/group_vars/k8s_cluster/addons.yml` (247 строк) — файла включения дополнительных компонентов кластера. Источник истины — [[versions/v2.29.0/inventory/addons|addons.yaml (справочник)]].
