...
# Облачные провайдеры в sample-inventory (v2.29.0)

Заметка описывает файлы `inventory/sample/group_vars/all/<cloud>.yml` тега **v2.29.0** (commit `9991412`). Источник истины — [[versions/v2.29.0/inventory/cloud-providers|cloud-providers.yaml]]; здесь дан человекочитаемый обзор.
...
В sample-inventory v2.29.0 присутствуют заготовки для 9 облачных провайдеров:
