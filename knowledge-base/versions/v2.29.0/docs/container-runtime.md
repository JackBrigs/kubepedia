...
# Container runtime в v2.29.0

Дайджест документации по container runtime строго с тега `v2.29.0` (commit `9991412`).
...
- Аутентификация в приватном реестре образов настраивается через
  ...
  подробно в [[versions/v2.29.0/docs/offline|Оффлайн-развёртывание и зеркала]].

Примечание: sandbox/pause image как отдельная переменная в `docs/CRI/containerd.md`
тега v2.29.0 не документирована; параметры образа pause относятся к переменным
download — см. [[versions/v2.29.0/variables/download|Переменные download]].
...
Файл `docs/operations/cgroups.md` тега v2.29.0 сам по себе не задаёт выбор
...
в v2.29.0 переменные.

## Источники

- `docs/CRI/containerd.md` — https://github.com/kubernetes-sigs/kubespray/blob/v2.29.0/docs/CRI/containerd.md
- `docs/CRI/cri-o.md` — https://github.com/kubernetes-sigs/kubespray/blob/v2.29.0/docs/CRI/cri-o.md
- `docs/CRI/docker.md` — https://github.com/kubernetes-sigs/kubespray/blob/v2.29.0/docs/CRI/docker.md
- `docs/CRI/gvisor.md` — https://github.com/kubernetes-sigs/kubespray/blob/v2.29.0/docs/CRI/gvisor.md
- `docs/CRI/kata-containers.md` — https://github.com/kubernetes-sigs/kubespray/blob/v2.29.0/docs/CRI/kata-containers.md
- `docs/operations/cgroups.md` — https://github.com/kubernetes-sigs/kubespray/blob/v2.29.0/docs/operations/cgroups.md

Связанные заметки: [[versions/v2.29.0/variables/container-runtime|Переменные рантайма]] · [[versions/v2.29.0/variables/download|Переменные download]] · [[versions/v2.29.0/README|Срез v2.29.0]]
