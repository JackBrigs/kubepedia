...
Дайджест документации `docs/operations/etcd.md` тега v2.29.0: типы развёртывания etcd, топология и экспозиция метрик.

Связанные заметки: [[versions/v2.29.0/variables/etcd|Переменные etcd]] · [[versions/v2.29.0/ansible-tags|Ansible-теги]] · [[versions/v2.29.0/README|Срез v2.29.0]].
...
- `docs/operations/etcd.md` (v2.29.0)
