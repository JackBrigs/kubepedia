...
# Эксплуатационные требования и troubleshooting в v2.29.0

Дайджест по требованиям к ядру, портам, надёжности при сбоях узлов и NTP. Данные взяты строго из документации тега `v2.29.0` (commit `9991412`).
...
- [[versions/v2.29.0/variables/k8s-cluster|Переменные ядра кластера]]
- [[versions/v2.29.0/variables/cni|Переменные CNI (Calico/Cilium)]]
- [[versions/v2.29.0/docs/security|Безопасность и hardening]]

## Источники

- `docs/operations/kernel-requirements.md` — <https://github.com/kubernetes-sigs/kubespray/blob/v2.29.0/docs/operations/kernel-requirements.md>
- `docs/operations/port-requirements.md` — <https://github.com/kubernetes-sigs/kubespray/blob/v2.29.0/docs/operations/port-requirements.md>
- `docs/advanced/kubernetes-reliability.md` — <https://github.com/kubernetes-sigs/kubespray/blob/v2.29.0/docs/advanced/kubernetes-reliability.md>
- `docs/advanced/ntp.md` — <https://github.com/kubernetes-sigs/kubespray/blob/v2.29.0/docs/advanced/ntp.md>
