...
Дайджест документации по настройке прокси строго с тега `v2.29.0` (commit `9991412`).
...
- `docs/advanced/proxy.md` — https://github.com/kubernetes-sigs/kubespray/blob/v2.29.0/docs/advanced/proxy.md
- `docs/advanced/mitogen.md` — https://github.com/kubernetes-sigs/kubespray/blob/v2.29.0/docs/advanced/mitogen.md

Связанные заметки: [[versions/v2.29.0/docs/offline|Оффлайн-развёртывание и зеркала]] · [[versions/v2.29.0/variables/download|Переменные download]] · [[versions/v2.29.0/README|Срез v2.29.0]]
