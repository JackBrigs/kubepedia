...
# Управление узлами и восстановление control plane в v2.29.0

Дайджест построен строго по документации тега `v2.29.0` (commit `9991412`): `docs/operations/nodes.md` и `docs/operations/recover-control-plane.md`. Выжимка, не дословный перевод; имена плейбуков, переменных и команд приведены точно.
...
Связанные срезы: [[versions/v2.29.0/ansible-tags|Ansible-теги запуска v2.29.0]] (reset, pre-remove, post-remove), [[versions/v2.29.0/variables/etcd|Переменные etcd v2.29.0]].

## Источники

- `docs/operations/nodes.md` (тег v2.29.0)
- `docs/operations/recover-control-plane.md` (тег v2.29.0)
