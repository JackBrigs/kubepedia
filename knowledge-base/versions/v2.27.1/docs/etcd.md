...
Дайджест документации `docs/operations/etcd.md` тега v2.27.1: типы развёртывания etcd, топология и экспозиция метрик.

Связанные заметки: [[versions/v2.27.1/variables/etcd|Переменные etcd]] · [[versions/v2.27.1/ansible-tags|Ansible-теги]] · [[versions/v2.27.1/README|Срез v2.27.1]].
...
- `docs/operations/etcd.md` (v2.27.1)
