...
Дайджест документации по настройке прокси строго с тега `v2.27.1` (commit `45140b5`).
...
- `docs/advanced/proxy.md` — https://github.com/kubernetes-sigs/kubespray/blob/v2.27.1/docs/advanced/proxy.md
- `docs/advanced/mitogen.md` — https://github.com/kubernetes-sigs/kubespray/blob/v2.27.1/docs/advanced/mitogen.md

Связанные заметки: [[versions/v2.27.1/docs/offline|Оффлайн-развёртывание и зеркала]] · [[versions/v2.27.1/variables/download|Переменные download]] · [[versions/v2.27.1/README|Срез v2.27.1]]
