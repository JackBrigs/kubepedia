...
# Sample-inventory: inventory.ini (v2.27.0)

Разбор `inventory/sample/inventory.ini` — файла описания хостов и групп. Ссылка на
срез: [[versions/v2.27.0/README|Срез v2.27.0]].
...
В v2.27.0 структура файла идентична более поздним версиям.
...
[[versions/v2.27.0/inventory/k8s-cluster|k8s-cluster.yaml]] и
[[versions/v2.27.0/inventory/addons|addons.yaml]]. Данный файл описывает только
