...
# Облачные провайдеры в sample-inventory (v2.27.0)

Заметка описывает файлы `inventory/sample/group_vars/all/<cloud>.yml` тега
**v2.27.0** (commit `9ec9b3a`). Источник истины —
[[versions/v2.27.0/inventory/cloud-providers|cloud-providers.yaml]]; здесь дан
...
> [!note] Отличия v2.27.0 от справочника v2.29.1
