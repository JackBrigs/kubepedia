...
# Sample-inventory: addons.yml (v2.27.0)
...
[[versions/v2.27.0/inventory/addons|addons.yaml (справочник)]].
...
> [!note] Отличия v2.27.0 от v2.29.1
...
- **RBD / CephFS Provisioner**: полные наборы `rbd_provisioner_*` и
  `cephfs_provisioner_*` (мониторы Ceph, пулы, секреты, StorageClass) — специфика v2.27.0.
...
Полный список — в справочнике [[versions/v2.27.0/inventory/addons|addons.yaml]].
