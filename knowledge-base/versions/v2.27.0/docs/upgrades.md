...
# Обновление кластера в v2.27.0

Дайджест построен строго по документации тега `v2.27.0` (commit `9ec9b3a`): `docs/operations/upgrades.md` и `docs/upgrades/migrate_docker2containerd.md`. Это выжимка, а не дословный перевод; имена переменных, тегов и команд приведены точно.
...
Подробности по тегам запуска: [[versions/v2.27.0/ansible-tags|Ansible-теги запуска v2.27.0]].
...
- `docs/operations/upgrades.md` (тег v2.27.0)
- `docs/upgrades/migrate_docker2containerd.md` (тег v2.27.0)
