...
## P0 — пробелы: запросы, на которые база не ответила (0)
_Прямое указание, что писать: это уже спрашивали, и ответа не нашлось._
_Источник: `reports/gaps.jsonl` (пишет `ask.py`, не коммитится — в строках ошибок бывают имена хостов)._
- пусто (или журнала ещё нет)
