...
| consul-k8s | `hashicorp/consul-k8s` | 115 | 42 | 4 | 210 | клон: CHANGELOG |
| node-feature-discovery | `kubernetes-sigs/node-feature-discovery` | 40 | 0 | 0 | 191 | GitHub Releases API |
| cilium | `cilium/cilium` | 130 | 0 | 213 | 173 | клон: CHANGELOG |
...
| calico | `projectcalico/calico` | 12 | 0 | 0 | 28 | GitHub Releases API |
