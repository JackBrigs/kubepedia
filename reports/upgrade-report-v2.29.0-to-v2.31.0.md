...
## Component version changes (v2.29.0 → v2.31.0)

| Component | v2.29.0 | v2.31.0 |
|---|---|---|
| Kubernetes (default / min) | 1.33.5 / 1.31.0 | **1.35.4** / **1.33.0** |
| etcd | 3.5.23 | **3.5.29** (1.33/1.34) / **3.6.10** (1.35) |
| containerd | 2.1.4 | **2.2.3** |
| runc | 1.3.2 | **1.4.2** |
| cni-plugins | 1.8.0 | **1.9.1** |
| Cilium | 1.18.2 | **1.19.3** |
| CoreDNS (default) | 1.12.0 | **1.12.4** |
| nerdctl | — | **2.2.2** |
| kube-vip (deployed) | v0.8.9 | v1.0.3 |
...
- **Kubernetes (default / min)** `1.33.5` (3 CVEs) → `1.35.4` (**2 CVEs**)  `[TROUBLE-KUBERNETES_KNOWN_CVES]`
    - cleared: CVE-2025-13281
    - **still exposed after the upgrade**: CVE-2024-7598, CVE-2025-1767
- **containerd** `2.1.4` (8 CVEs) → `2.2.3` (**6 CVEs**)  `[TROUBLE-CONTAINERD_KNOWN_CVES]`
    - cleared: CVE-2024-25621, CVE-2025-64329
...
- **runc** `1.3.2` (4 CVEs) → `1.4.2` (**1 CVE**)  `[TROUBLE-RUNC_KNOWN_CVES]`
    - cleared: CVE-2025-31133, CVE-2025-52565, CVE-2025-52881
...
- **Cilium** `1.18.2` (6 CVEs) → `1.19.3` (**1 CVE**)  `[TROUBLE-CILIUM_KNOWN_CVES]`
    - cleared: CVE-2025-64715, CVE-2026-26963, CVE-2026-33726, CVE-2026-41520, CVE-2026-49445
    - **still exposed after the upgrade**: CVE-2026-53935
- **CoreDNS (default)** `1.12.0` (10 CVEs) → `1.12.4` (**8 CVEs**)  `[TROUBLE-COREDNS_KNOWN_CVES]`
...
## Kubernetes layer changes (new minors: 1.34, 1.35)

Minors that enter the support window on this path — read their operator-relevant changes:
- **Kubernetes 1.34** — Kubernetes 1.34 — operator-relevant changes  `[CONCEPT-K8S_1_34_CHANGES]`
...
- `CONCEPT-K8S_1_34_CHANGES` — Kubernetes 1.34 — operator-relevant changes  (kb/kubernetes/changes-1.34.md)
