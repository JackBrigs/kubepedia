---
id: TROUBLE-AWS_EBS_CSI_1_18_DEFECTS
type: troubleshooting
title: "aws-ebs-csi 1.18: defects fixed in the 1.18 line"
status: active
...
confidence: verified
aliases:
  - aws-ebs-csi 1.18 known issues
  - aws-ebs-csi 1.18 fixed in
...
sources:
  - type: docs
    path: kubernetes-sigs/aws-ebs-csi-driver release notes for the 1.18 line — bug-fix entries
...
# aws-ebs-csi 1.18: defects fixed in the 1.18 line

## Summary

**5 defects** the project fixed across **1 releases** of the 1.18 line, from 1.18.0 to
