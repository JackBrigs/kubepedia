---
id: TROUBLE-GCP_PD_CSI_0_6_DEFECTS
type: troubleshooting
title: "gcp-pd-csi 0.6: defects fixed in the 0.6 line"
status: active
...
confidence: verified
aliases:
  - gcp-pd-csi 0.6 known issues
  - gcp-pd-csi 0.6 fixed in
...
sources:
  - type: docs
    path: kubernetes-sigs/gcp-compute-persistent-disk-csi-driver release notes for the 0.6 line — bug-fix entries
...
# gcp-pd-csi 0.6: defects fixed in the 0.6 line

## Summary

**8 defects** the project fixed across **1 releases** of the 0.6 line, from 0.6.0 to
