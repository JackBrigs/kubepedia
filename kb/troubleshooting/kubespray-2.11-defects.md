---
id: TROUBLE-KUBESPRAY_2_11_DEFECTS
type: troubleshooting
title: "kubespray 2.11: defects fixed in the 2.11 line"
status: active
...
confidence: verified
aliases:
  - kubespray 2.11 known issues
  - kubespray 2.11 fixed in
...
sources:
  - type: docs
    path: kubernetes-sigs/kubespray release notes for the 2.11 line — bug-fix entries
...
# kubespray 2.11: defects fixed in the 2.11 line

## Summary

**5 defects** the project fixed across **1 releases** of the 2.11 line, from 2.11.0 to
