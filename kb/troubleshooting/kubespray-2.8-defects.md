---
id: TROUBLE-KUBESPRAY_2_8_DEFECTS
type: troubleshooting
title: "kubespray 2.8: defects fixed in the 2.8 line"
status: active
...
confidence: verified
aliases:
  - kubespray 2.8 known issues
  - kubespray 2.8 fixed in
...
sources:
  - type: docs
    path: kubernetes-sigs/kubespray release notes for the 2.8 line — bug-fix entries
...
# kubespray 2.8: defects fixed in the 2.8 line

## Summary

**5 defects** the project fixed across **2 releases** of the 2.8 line, from 2.8.0 to
2.8.1. A cluster running a version below the one an entry sits under still carries that defect.
...
Compare the running version against **2.8.1**, the newest release recorded here for this line.
