---
id: TROUBLE-KATA_CONTAINERS_3_10_DEFECTS
type: troubleshooting
title: "kata-containers 3.10: defects fixed in the 3.10 line"
status: active
...
confidence: verified
aliases:
  - kata-containers 3.10 known issues
  - kata-containers 3.10 fixed in
...
sources:
  - type: docs
    path: kata-containers/kata-containers release notes for the 3.10 line — bug-fix entries
...
# kata-containers 3.10: defects fixed in the 3.10 line
...
Compare the running version against **3.10.1**, the newest release recorded here for this line.
