...
sources:
  - type: docs
    path: youki-dev/youki release notes — "breaking changes" / "action required" entries
...
6 releases from 0.2.0 to 0.6.0. Read this before planning
...
- Upstream releases of `youki-dev/youki`, read 2026-07-31 via `scripts/upstream_issues.py`;
  raw extraction in `reports/upstream/youki.json`.
