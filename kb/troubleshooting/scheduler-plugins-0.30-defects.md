---
id: TROUBLE-SCHEDULER_PLUGINS_0_30_DEFECTS
type: troubleshooting
title: "scheduler-plugins 0.30: defects fixed in the 0.30 line"
status: active
kubespray_version: null
kubernetes_version: null
component_version: ">=0.30.0 <0.31.0"
verified_at: "2026-07-31"
confidence: verified
aliases:
  - scheduler-plugins 0.30 known issues
  - scheduler-plugins 0.30 fixed in
...
sources:
  - type: docs
    path: kubernetes-sigs/scheduler-plugins release notes for the 0.30 line — bug-fix entries
...
# scheduler-plugins 0.30: defects fixed in the 0.30 line
...
- fix: fix wrong PreemptionToleration policy example by @odeinjul in https://github.com/kubernetes-sigs/scheduler-plugins/pull/805
...
Compare the running version against **0.30.6**, the newest release recorded here for this line.
