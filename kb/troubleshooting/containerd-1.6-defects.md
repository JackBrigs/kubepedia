...
**239 defects** the project fixed across **36 releases** of the 1.6 line, from 1.6.0 to
...
- Fix $(PWD) issue for Windows makefile ([#6394](https://github.com/containerd/containerd/pull/6394)) Fix $(PWD) issue for Windows makefile
...
- Fix default makefile target for windows ([#6322](https://github.com/containerd/containerd/pull/6322)) Fix default makefile target for windows
...
- Fix typo in the NewContainer function documentation ([#6110](https://github.com/containerd/containerd/pull/6110)) Fix typo in the NewContainer function documentation
...
- Fixes for Windows CI ([#6081](https://github.com/containerd/containerd/pull/6081)) Pin mingw to version 10.2.0 Update to golang 1.17.1 Install nssm
...
- Fix typo ([#5995](https://github.com/containerd/containerd/pull/5995)) Fix typo
...
- Makefile: fix passing build tags ([#5590](https://github.com/containerd/containerd/pull/5590)) Makefile: pass build tags to manpage build process Makefile: fix tags parameter computation
...
- Makefile: fix DESTDIR and PREFIX concatenation ([#5662](https://github.com/containerd/containerd/pull/5662)) Makefile: fix DESTDIR and PREFIX concatenation
- CI: Switch to the available latest images ([#5625](https://github.com/containerd/containerd/pull/5625)) CI: Switch to available latest images fix deprecation config for default runtime
...
- Makefile: fix DESTDIR environment variable behaviour ([#5535](https://github.com/containerd/containerd/pull/5535)) Makefile: fix DESTDIR environment variable behaviour
...
- chore: fix readme typo ([containerd/imgcrypt#87](https://github.com/containerd/imgcrypt/pull/87)) [`98e43be`](https://github.com/containerd/imgcrypt/commit/98e43be32177a4dbfce2d4ecaab8bb301f311d20) chore: fix readme typo
