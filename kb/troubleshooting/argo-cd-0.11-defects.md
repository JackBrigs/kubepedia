---
id: TROUBLE-ARGO_CD_0_11_DEFECTS
type: troubleshooting
title: "argo-cd 0.11: defects fixed in the 0.11 line"
status: active
...
confidence: verified
aliases:
  - argo-cd 0.11 known issues
  - argo-cd 0.11 fixed in
...
sources:
  - type: docs
    path: argoproj/argo-cd release notes for the 0.11 line — bug-fix entries
...
# argo-cd 0.11: defects fixed in the 0.11 line

## Summary

**5 defects** the project fixed across **2 releases** of the 0.11 line, from 0.11.1 to
0.11.2. A cluster running a version below the one an entry sits under still carries that defect.
...
Compare the running version against **0.11.2**, the newest release recorded here for this line.
