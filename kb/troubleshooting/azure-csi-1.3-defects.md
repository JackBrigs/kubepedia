---
id: TROUBLE-AZURE_CSI_1_3_DEFECTS
type: troubleshooting
title: "azure-csi 1.3: defects fixed in the 1.3 line"
status: active
...
confidence: verified
aliases:
  - azure-csi 1.3 known issues
  - azure-csi 1.3 fixed in
...
sources:
  - type: docs
    path: kubernetes-sigs/azuredisk-csi-driver release notes for the 1.3 line — bug-fix entries
...
# azure-csi 1.3: defects fixed in the 1.3 line
...
- fix: RedHat/CentOS issue in helm installation by @andyzhangx in https://github.com/kubernetes-sigs/azuredisk-csi-driver/pull/852
- fix: remove unnecessary lock in NodePublish by @andyzhangx in https://github.com/kubernetes-sigs/azuredisk-csi-driver/pull/854
