---
id: TROUBLE-CILIUM_1_0_DEFECTS
type: troubleshooting
title: "cilium 1.0: defects fixed in the 1.0 line"
status: active
...
sources:
  - type: docs
    path: cilium/cilium release notes for the 1.0 line — bug-fix entries
...
# cilium 1.0: defects fixed in the 1.0 line
...
- Improvements in `runtime.Poller[T]` `Poll()` shouldn't cache errors, allowing for additional retries when in a non-terminal state. `Result()` will cache the terminal result or error but not transient errors, allowing for additional retries
