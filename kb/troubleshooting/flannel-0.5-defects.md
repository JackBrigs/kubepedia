---
id: TROUBLE-FLANNEL_0_5_DEFECTS
type: troubleshooting
title: "flannel 0.5: defects fixed in the 0.5 line"
status: active
...
confidence: verified
aliases:
  - flannel 0.5 known issues
  - flannel 0.5 fixed in
...
sources:
  - type: docs
    path: flannel-io/flannel release notes for the 0.5 line — bug-fix entries
...
# flannel 0.5: defects fixed in the 0.5 line

## Summary

**5 defects** the project fixed across **5 releases** of the 0.5 line, from 0.5.0 to
0.5.5. A cluster running a version below the one an entry sits under still carries that defect.
...
Compare the running version against **0.5.5**, the newest release recorded here for this line.
