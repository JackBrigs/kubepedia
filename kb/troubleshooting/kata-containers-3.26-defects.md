---
id: TROUBLE-KATA_CONTAINERS_3_26_DEFECTS
type: troubleshooting
title: "kata-containers 3.26: defects fixed in the 3.26 line"
status: active
kubespray_version: null
kubernetes_version: null
component_version: ">=3.26.0 <3.27.0"
verified_at: "2026-07-31"
confidence: verified
aliases:
  - kata-containers 3.26 known issues
  - kata-containers 3.26 fixed in
...
sources:
  - type: docs
    path: kata-containers/kata-containers release notes for the 3.26 line — bug-fix entries
...
# kata-containers 3.26: defects fixed in the 3.26 line

## Summary

**5 defects** the project fixed across **1 releases** of the 3.26 line, from 3.26.0 to
3.26.0. A cluster running a version below the one an entry sits under still carries that defect.
...
Compare the running version against **3.26.0**, the newest release recorded here for this line.
