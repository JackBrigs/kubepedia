---
id: TROUBLE-KATA_CONTAINERS_3_6_DEFECTS
type: troubleshooting
title: "kata-containers 3.6: defects fixed in the 3.6 line"
status: active
...
confidence: verified
aliases:
  - kata-containers 3.6 known issues
  - kata-containers 3.6 fixed in
...
sources:
  - type: docs
    path: kata-containers/kata-containers release notes for the 3.6 line — bug-fix entries
...
# kata-containers 3.6: defects fixed in the 3.6 line
...
Compare the running version against **3.6.0**, the newest release recorded here for this line.
