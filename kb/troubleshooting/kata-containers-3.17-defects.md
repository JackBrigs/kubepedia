---
id: TROUBLE-KATA_CONTAINERS_3_17_DEFECTS
type: troubleshooting
title: "kata-containers 3.17: defects fixed in the 3.17 line"
status: active
...
confidence: verified
aliases:
  - kata-containers 3.17 known issues
  - kata-containers 3.17 fixed in
...
sources:
  - type: docs
    path: kata-containers/kata-containers release notes for the 3.17 line — bug-fix entries
...
# kata-containers 3.17: defects fixed in the 3.17 line
...
- kata-deploy: fix bug when config does not exist by @kimullaa in https://github.com/kata-containers/kata-containers/pull/11093
...
Compare the running version against **3.17.0**, the newest release recorded here for this line.
