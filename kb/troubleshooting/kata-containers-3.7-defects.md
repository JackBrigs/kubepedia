---
id: TROUBLE-KATA_CONTAINERS_3_7_DEFECTS
type: troubleshooting
title: "kata-containers 3.7: defects fixed in the 3.7 line"
status: active
...
confidence: verified
aliases:
  - kata-containers 3.7 known issues
  - kata-containers 3.7 fixed in
...
sources:
  - type: docs
    path: kata-containers/kata-containers release notes for the 3.7 line — bug-fix entries
...
# kata-containers 3.7: defects fixed in the 3.7 line
...
Compare the running version against **3.7.0**, the newest release recorded here for this line.
