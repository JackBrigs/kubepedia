---
id: TROUBLE-GCP_PD_CSI_1_18_DEFECTS
type: troubleshooting
title: "gcp-pd-csi 1.18: defects fixed in the 1.18 line"
status: active
...
confidence: verified
aliases:
  - gcp-pd-csi 1.18 known issues
  - gcp-pd-csi 1.18 fixed in
...
sources:
  - type: docs
    path: kubernetes-sigs/gcp-compute-persistent-disk-csi-driver release notes for the 1.18 line — bug-fix entries
...
# gcp-pd-csi 1.18: defects fixed in the 1.18 line

## Summary

**8 defects** the project fixed across **2 releases** of the 1.18 line, from 1.18.0 to
1.18.1. A cluster running a version below the one an entry sits under still carries that defect.
...
- [release-1.18] Fix Gen4 Custom VM Cases by @k8s-infra-cherrypick-robot in https://github.com/kubernetes-sigs/gcp-compute-persistent-disk-csi-driver/pull/2098
...
Compare the running version against **1.18.1**, the newest release recorded here for this line.
