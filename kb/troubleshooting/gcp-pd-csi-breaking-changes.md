...
sources:
  - type: docs
    path: kubernetes-sigs/gcp-compute-persistent-disk-csi-driver release notes — "breaking changes" / "action required" entries
...
3 releases from 0.5.1 to 0.7.0. Read this before planning
...
- Upstream releases of `kubernetes-sigs/gcp-compute-persistent-disk-csi-driver`, read 2026-07-31 via `scripts/upstream_issues.py`;
  raw extraction in `reports/upstream/gcp-pd-csi.json`.
