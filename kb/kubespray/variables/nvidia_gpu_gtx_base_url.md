---
id: VARIABLE-NVIDIA_GPU_GTX_BASE_URL
type: variable
title: nvidia_gpu_gtx_base_url
status: active
...
sources:
  - type: code
    ...
    note: "default: http://us.download.nvidia.com/XFree86/Linux-x86_64/"
relations: []
---
...
Kubespray variable `nvidia_gpu_gtx_base_url` — default `http://us.download.nvidia.com/XFree86/Linux-x86_64/`. Defined in `roles/kubernetes-apps/container_engine_accelerator/nvidia_gpu/defaults/main.yml`. Present in Kubespray
