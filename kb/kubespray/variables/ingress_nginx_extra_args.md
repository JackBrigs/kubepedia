---
id: VARIABLE-INGRESS_NGINX_EXTRA_ARGS
type: variable
title: ingress_nginx_extra_args
status: active
...
Kubespray variable `ingress_nginx_extra_args` — default `[]`. Defined in `roles/kubernetes-apps/ingress_controller/ingress_nginx/defaults/main.yml`. Present in Kubespray
