---
id: VARIABLE-EXTERNAL_VSPHERE_CLOUD_CONTROLLER_EXTRA_ARGS
type: variable
title: external_vsphere_cloud_controller_extra_args
status: active
...
Kubespray variable `external_vsphere_cloud_controller_extra_args` — default `{}`. Defined in `roles/kubernetes-apps/external_cloud_controller/vsphere/defaults/main.yml`. Present in Kubespray
