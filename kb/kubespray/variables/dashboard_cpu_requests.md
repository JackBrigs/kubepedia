---
id: VARIABLE-DASHBOARD_CPU_REQUESTS
type: variable
title: dashboard_cpu_requests
status: active
...
Kubespray variable `dashboard_cpu_requests` — default `50m`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
