---
id: VARIABLE-CINDER_APPLICATION_CREDENTIAL_ID
type: variable
title: cinder_application_credential_id
status: active
...
confidence: verified
aliases:
  - cinder_application_credential_id
tags:
  - kubernetes-apps
  - csi-driver
  - variable
...
Kubespray variable `cinder_application_credential_id` — default `{{ lookup('env', 'OS_APPLICATION_CREDENTIAL_ID') }}`. Defined in `roles/kubernetes-apps/csi_driver/cinder/defaults/main.yml`. Present in Kubespray
