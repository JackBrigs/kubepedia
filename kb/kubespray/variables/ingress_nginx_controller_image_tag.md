---
id: VARIABLE-INGRESS_NGINX_CONTROLLER_IMAGE_TAG
type: variable
title: ingress_nginx_controller_image_tag
status: active
...
sources:
  - type: code
    ...
    note: "default: v{{ ingress_nginx_version }}"
relations: []
---
...
Kubespray variable `ingress_nginx_controller_image_tag` — default `v{{ ingress_nginx_version }}`. Defined in `roles/kubespray_defaults/defaults/main/download.yml`. Present in Kubespray
