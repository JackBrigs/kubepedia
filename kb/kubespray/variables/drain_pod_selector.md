---
id: VARIABLE-DRAIN_POD_SELECTOR
type: variable
title: drain_pod_selector
status: active
...
Kubespray variable `drain_pod_selector` — default `(empty)`. Defined in `roles/upgrade/pre-upgrade/defaults/main.yml`. Present in Kubespray
