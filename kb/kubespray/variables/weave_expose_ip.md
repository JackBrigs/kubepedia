---
id: VARIABLE-WEAVE_EXPOSE_IP
type: variable
title: weave_expose_ip
status: active
...
Kubespray variable `weave_expose_ip` — default `~`. Defined in `roles/network_plugin/weave/defaults/main.yml`. Present in Kubespray
