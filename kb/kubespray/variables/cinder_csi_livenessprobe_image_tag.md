---
id: VARIABLE-CINDER_CSI_LIVENESSPROBE_IMAGE_TAG
type: variable
title: cinder_csi_livenessprobe_image_tag
status: active
...
confidence: verified
aliases:
  - cinder_csi_livenessprobe_image_tag
tags:
  - kubernetes-apps
  - csi-driver
  - variable
...
Kubespray variable `cinder_csi_livenessprobe_image_tag` — default `v2.11.0`. Defined in `roles/kubernetes-apps/csi_driver/cinder/defaults/main.yml`. Present in Kubespray
