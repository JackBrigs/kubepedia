---
id: VARIABLE-CALICO_IPIP_MODE
type: variable
title: calico_ipip_mode
status: active
...
sources:
  - type: code
    ...
    note: "default: Never  # valid values are 'Always', 'Never' and 'CrossSubnet"
relations: []
---
...
Kubespray variable `calico_ipip_mode` — default `Never  # valid values are 'Always', 'Never' and 'CrossSubnet`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
