---
id: VARIABLE-INGRESS_NGINX_CONFIGMAP_TCP_SERVICES
type: variable
title: ingress_nginx_configmap_tcp_services
status: active
...
Kubespray variable `ingress_nginx_configmap_tcp_services` — default `{}`. Defined in `roles/kubernetes-apps/ingress_controller/ingress_nginx/defaults/main.yml`. Present in Kubespray
