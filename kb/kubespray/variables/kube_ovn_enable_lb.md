---
id: VARIABLE-KUBE_OVN_ENABLE_LB
type: variable
title: kube_ovn_enable_lb
status: active
...
Kubespray variable `kube_ovn_enable_lb` — default `true`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
