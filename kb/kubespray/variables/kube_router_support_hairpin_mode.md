---
id: VARIABLE-KUBE_ROUTER_SUPPORT_HAIRPIN_MODE
type: variable
title: kube_router_support_hairpin_mode
status: active
...
confidence: verified
aliases:
  - kube_router_support_hairpin_mode
tags:
  - network-plugin
  - kube-router
  - variable
...
Kubespray variable `kube_router_support_hairpin_mode` — default `false`. Defined in `roles/network_plugin/kube-router/defaults/main.yml`. Present in Kubespray
