---
id: VARIABLE-NODELOCALDNS_SECONDARY_PROMETHEUS_PORT
type: variable
title: nodelocaldns_secondary_prometheus_port
status: active
...
confidence: verified
aliases:
  - nodelocaldns_secondary_prometheus_port
tags:
  - kubernetes-apps
  - ansible
  - variable
...
Kubespray variable `nodelocaldns_secondary_prometheus_port` — default `9255`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
