---
id: VARIABLE-METRICS_SERVER_LIMITS_MEMORY
type: variable
title: metrics_server_limits_memory
status: active
...
Kubespray variable `metrics_server_limits_memory` — default `200Mi`. Defined in `roles/kubernetes-apps/metrics_server/defaults/main.yml`. Present in Kubespray
