---
id: VARIABLE-KUBE_OVN_ENCAP_CHECKSUM
type: variable
title: kube_ovn_encap_checksum
status: active
...
Kubespray variable `kube_ovn_encap_checksum` — default `true`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
