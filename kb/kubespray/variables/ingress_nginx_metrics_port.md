---
id: VARIABLE-INGRESS_NGINX_METRICS_PORT
type: variable
title: ingress_nginx_metrics_port
status: active
...
Kubespray variable `ingress_nginx_metrics_port` — default `10254`. Defined in `roles/kubernetes-apps/ingress_controller/ingress_nginx/defaults/main.yml`. Present in Kubespray
