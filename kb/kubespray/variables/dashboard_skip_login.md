---
id: VARIABLE-DASHBOARD_SKIP_LOGIN
type: variable
title: dashboard_skip_login
status: active
...
Kubespray variable `dashboard_skip_login` — default `false`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
