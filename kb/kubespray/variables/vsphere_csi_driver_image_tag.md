---
id: VARIABLE-VSPHERE_CSI_DRIVER_IMAGE_TAG
type: variable
title: vsphere_csi_driver_image_tag
status: active
...
Kubespray variable `vsphere_csi_driver_image_tag` — default `v3.3.1`. Defined in `roles/kubernetes-apps/csi_driver/vsphere/defaults/main.yml`. Present in Kubespray
