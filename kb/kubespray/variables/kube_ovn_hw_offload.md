---
id: VARIABLE-KUBE_OVN_HW_OFFLOAD
type: variable
title: kube_ovn_hw_offload
status: active
...
Kubespray variable `kube_ovn_hw_offload` — default `false`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
