---
id: VARIABLE-VSPHERE_CSI_CONTROLLER
type: variable
title: vsphere_csi_controller
status: active
...
Kubespray variable `vsphere_csi_controller` — default `v3.3.1`. Defined in `roles/kubernetes-apps/csi_driver/vsphere/defaults/main.yml`. Present in Kubespray
