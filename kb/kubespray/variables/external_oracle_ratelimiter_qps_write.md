---
id: VARIABLE-EXTERNAL_ORACLE_RATELIMITER_QPS_WRITE
type: variable
title: external_oracle_ratelimiter_qps_write
status: active
...
confidence: verified
aliases:
  - external_oracle_ratelimiter_qps_write
tags:
  - kubernetes-apps
...
Kubespray variable `external_oracle_ratelimiter_qps_write` — default `20.0`. Defined in `roles/kubernetes-apps/external_cloud_controller/oci/defaults/main.yml`. Present in Kubespray
