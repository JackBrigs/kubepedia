---
id: VARIABLE-NODELOCALDNS_MEMORY_REQUESTS
type: variable
title: nodelocaldns_memory_requests
status: active
...
Kubespray variable `nodelocaldns_memory_requests` — default `70Mi`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
