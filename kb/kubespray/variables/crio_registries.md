---
id: VARIABLE-CRIO_REGISTRIES
type: variable
title: crio_registries
status: active
...
Kubespray variable `crio_registries` — default `[]`. Defined in `roles/container-engine/cri-o/defaults/main.yml`. Present in Kubespray
