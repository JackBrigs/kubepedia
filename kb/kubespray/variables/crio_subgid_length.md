---
id: VARIABLE-CRIO_SUBGID_LENGTH
type: variable
title: crio_subgid_length
status: active
...
Kubespray variable `crio_subgid_length` — default `16777216`. Defined in `roles/container-engine/cri-o/defaults/main.yml`. Present in Kubespray
