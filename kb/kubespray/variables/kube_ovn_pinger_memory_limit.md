---
id: VARIABLE-KUBE_OVN_PINGER_MEMORY_LIMIT
type: variable
title: kube_ovn_pinger_memory_limit
status: active
...
Kubespray variable `kube_ovn_pinger_memory_limit` — default `400Mi`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
