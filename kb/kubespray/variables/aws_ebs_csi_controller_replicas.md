---
id: VARIABLE-AWS_EBS_CSI_CONTROLLER_REPLICAS
type: variable
title: aws_ebs_csi_controller_replicas
status: active
...
Kubespray variable `aws_ebs_csi_controller_replicas` — default `1`. Defined in `roles/kubernetes-apps/csi_driver/aws_ebs/defaults/main.yml`. Present in Kubespray
