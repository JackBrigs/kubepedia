---
id: VARIABLE-DRAIN_FALLBACK_TIMEOUT
type: variable
title: drain_fallback_timeout
status: active
...
Kubespray variable `drain_fallback_timeout` — default `360s`. Defined in `roles/upgrade/pre-upgrade/defaults/main.yml`. Present in Kubespray
