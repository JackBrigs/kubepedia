---
id: VARIABLE-EXTERNAL_ORACLE_AUTH_USE_INSTANCE_PRINCIPALS
type: variable
title: external_oracle_auth_use_instance_principals
status: active
...
confidence: verified
aliases:
  - external_oracle_auth_use_instance_principals
tags:
  - kubernetes-apps
...
Kubespray variable `external_oracle_auth_use_instance_principals` — default `false`. Defined in `roles/kubernetes-apps/external_cloud_controller/oci/defaults/main.yml`. Present in Kubespray
