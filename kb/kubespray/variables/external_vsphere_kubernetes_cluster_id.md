---
id: VARIABLE-EXTERNAL_VSPHERE_KUBERNETES_CLUSTER_ID
type: variable
title: external_vsphere_kubernetes_cluster_id
status: active
...
sources:
  - type: code
    ...
    note: "default: kubernetes-cluster-id"
relations: []
---
...
Kubespray variable `external_vsphere_kubernetes_cluster_id` — default `kubernetes-cluster-id`. Defined in `roles/kubernetes-apps/csi_driver/vsphere/defaults/main.yml`. Present in Kubespray
