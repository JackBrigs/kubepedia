---
id: VARIABLE-KUBE_ROUTER_ADVERTISE_LOADBALANCER_IP
type: variable
title: kube_router_advertise_loadbalancer_ip
status: active
...
Kubespray variable `kube_router_advertise_loadbalancer_ip` — default `false`. Defined in `roles/network_plugin/kube-router/defaults/main.yml`. Present in Kubespray
