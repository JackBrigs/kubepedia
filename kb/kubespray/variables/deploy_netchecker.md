---
id: VARIABLE-DEPLOY_NETCHECKER
type: variable
title: deploy_netchecker
status: active
...
Kubespray variable `deploy_netchecker` — default `false`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
