---
id: VARIABLE-WEAVE_NPC_IMAGE_REPO
type: variable
title: weave_npc_image_repo
status: active
...
sources:
  - type: code
    ...
    note: "default: {{ docker_image_repo }}/rajchaudhuri/weave-npc"
relations: []
---
...
Kubespray variable `weave_npc_image_repo` — default `{{ docker_image_repo }}/rajchaudhuri/weave-npc`. Defined in `roles/kubespray_defaults/defaults/main/download.yml`. Present in Kubespray
