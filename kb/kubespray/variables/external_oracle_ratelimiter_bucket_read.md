---
id: VARIABLE-EXTERNAL_ORACLE_RATELIMITER_BUCKET_READ
type: variable
title: external_oracle_ratelimiter_bucket_read
status: active
...
confidence: verified
aliases:
  - external_oracle_ratelimiter_bucket_read
tags:
  - kubernetes-apps
...
Kubespray variable `external_oracle_ratelimiter_bucket_read` — default `5`. Defined in `roles/kubernetes-apps/external_cloud_controller/oci/defaults/main.yml`. Present in Kubespray
