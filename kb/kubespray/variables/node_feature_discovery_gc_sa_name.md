---
id: VARIABLE-NODE_FEATURE_DISCOVERY_GC_SA_NAME
type: variable
title: node_feature_discovery_gc_sa_name
status: active
...
confidence: verified
aliases:
  - node_feature_discovery_gc_sa_name
tags:
  - kubernetes-apps
...
sources:
  - type: code
    ...
    note: "default: node-feature-discovery-gc"
relations: []
---
...
Kubespray variable `node_feature_discovery_gc_sa_name` — default `node-feature-discovery-gc`. Defined in `roles/kubernetes-apps/node_feature_discovery/defaults/main.yml`. Present in Kubespray
