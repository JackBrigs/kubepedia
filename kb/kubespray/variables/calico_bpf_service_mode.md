---
id: VARIABLE-CALICO_BPF_SERVICE_MODE
type: variable
title: calico_bpf_service_mode
status: active
...
Kubespray variable `calico_bpf_service_mode` — default `Tunnel`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
