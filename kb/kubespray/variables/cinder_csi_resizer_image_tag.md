---
id: VARIABLE-CINDER_CSI_RESIZER_IMAGE_TAG
type: variable
title: cinder_csi_resizer_image_tag
status: active
...
Kubespray variable `cinder_csi_resizer_image_tag` — default `v1.9.2`. Defined in `roles/kubernetes-apps/csi_driver/cinder/defaults/main.yml`. Present in Kubespray
