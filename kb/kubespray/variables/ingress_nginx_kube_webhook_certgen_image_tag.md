---
id: VARIABLE-INGRESS_NGINX_KUBE_WEBHOOK_CERTGEN_IMAGE_TAG
type: variable
title: ingress_nginx_kube_webhook_certgen_image_tag
status: active
...
confidence: verified
aliases:
  - ingress_nginx_kube_webhook_certgen_image_tag
tags:
  - kubespray-defaults
  - variable
sources:
...
Kubespray variable `ingress_nginx_kube_webhook_certgen_image_tag` — default `v1.6.3`. Defined in `roles/kubespray_defaults/defaults/main/download.yml`. Present in Kubespray
