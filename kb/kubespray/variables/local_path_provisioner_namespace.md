---
id: VARIABLE-LOCAL_PATH_PROVISIONER_NAMESPACE
type: variable
title: local_path_provisioner_namespace
status: active
...
sources:
  - type: code
    ...
    note: "default: local-path-storage"
relations: []
---
...
Kubespray variable `local_path_provisioner_namespace` — default `local-path-storage`. Defined in `roles/kubernetes-apps/external_provisioner/local_path_provisioner/defaults/main.yml`. Present in Kubespray
