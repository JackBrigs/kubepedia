---
id: VARIABLE-DOCKER_RH_REPO_GPGKEY
type: variable
title: docker_rh_repo_gpgkey
status: active
...
sources:
  - type: code
    ...
    note: "CentOS/RedHat docker-ce repo GPG key URL used by rh_docker.repo template"
relations:
  - type: see_also
...
## Summary
URL of the GPG key for the CentOS/RHEL Docker CE yum repository. Rendered into `roles/container-engine/docker/templates/rh_docker.repo.j2`.
...
## Compatibility
Kubespray v2.29.0 through v2.31.0. Relevant on RHEL-family hosts when `container_manager == 'docker'`. Related: `docker_rh_repo_base_url`.
