---
id: VARIABLE-CINDER_CSI_PROVISIONER_IMAGE_TAG
type: variable
title: cinder_csi_provisioner_image_tag
status: active
...
confidence: verified
aliases:
  - cinder_csi_provisioner_image_tag
tags:
  - kubernetes-apps
  - csi-driver
  - variable
...
Kubespray variable `cinder_csi_provisioner_image_tag` — default `v3.6.2`. Defined in `roles/kubernetes-apps/csi_driver/cinder/defaults/main.yml`. Present in Kubespray
