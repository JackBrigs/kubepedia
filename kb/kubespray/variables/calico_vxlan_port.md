---
id: VARIABLE-CALICO_VXLAN_PORT
type: variable
title: calico_vxlan_port
status: active
...
Kubespray variable `calico_vxlan_port` — default `4789`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
