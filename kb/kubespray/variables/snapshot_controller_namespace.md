---
id: VARIABLE-SNAPSHOT_CONTROLLER_NAMESPACE
type: variable
title: snapshot_controller_namespace
status: active
...
Kubespray variable `snapshot_controller_namespace` — default `kube-system`. Defined in `roles/kubernetes-apps/snapshots/snapshot-controller/defaults/main.yml`. Present in Kubespray
