---
id: VARIABLE-CEPHFS_PROVISIONER_ENABLED
type: variable
title: cephfs_provisioner_enabled
status: active
...
Kubespray variable `cephfs_provisioner_enabled` — default `false`. Defined in `roles/kubespray-defaults/defaults/main/main.yml`. Present in Kubespray
