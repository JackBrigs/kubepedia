---
id: VARIABLE-CALICO_LOGLEVEL
type: variable
title: calico_loglevel
status: active
...
Kubespray variable `calico_loglevel` — default `info`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
