---
id: VARIABLE-NETCHECK_AGENT_IMAGE_TAG
type: variable
title: netcheck_agent_image_tag
status: active
...
Kubespray variable `netcheck_agent_image_tag` — default `v{{ netcheck_version }}`. Defined in `roles/kubespray_defaults/defaults/main/download.yml`. Present in Kubespray
