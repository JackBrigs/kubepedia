---
id: VARIABLE-DASHBOARD_IMAGE_TAG
type: variable
title: dashboard_image_tag
status: active
...
Kubespray variable `dashboard_image_tag` — default `v2.7.0`. Defined in `roles/kubespray_defaults/defaults/main/download.yml`. Present in Kubespray
