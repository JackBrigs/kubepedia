---
id: VARIABLE-EXTERNAL_ORACLE_RATELIMITER_BUCKET_WRITE
type: variable
title: external_oracle_ratelimiter_bucket_write
status: active
...
confidence: verified
aliases:
  - external_oracle_ratelimiter_bucket_write
tags:
  - kubernetes-apps
...
Kubespray variable `external_oracle_ratelimiter_bucket_write` — default `5`. Defined in `roles/kubernetes-apps/external_cloud_controller/oci/defaults/main.yml`. Present in Kubespray
