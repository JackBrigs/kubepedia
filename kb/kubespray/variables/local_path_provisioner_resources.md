---
id: VARIABLE-LOCAL_PATH_PROVISIONER_RESOURCES
type: variable
title: local_path_provisioner_resources
status: active
...
Kubespray variable `local_path_provisioner_resources` — default `{}`. Defined in `roles/kubernetes-apps/external_provisioner/local_path_provisioner/defaults/main.yml`. Present in Kubespray
