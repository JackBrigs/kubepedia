---
id: VARIABLE-UPGRADE_NODE_UNCORDON_AFTER_DRAIN_FAILURE
type: variable
title: upgrade_node_uncordon_after_drain_failure
status: active
...
confidence: verified
aliases:
  - upgrade_node_uncordon_after_drain_failure
tags:
  - upgrade
  - pre-upgrade
  - variable
...
Kubespray variable `upgrade_node_uncordon_after_drain_failure` — default `true`. Defined in `roles/upgrade/pre-upgrade/defaults/main.yml`. Present in Kubespray
