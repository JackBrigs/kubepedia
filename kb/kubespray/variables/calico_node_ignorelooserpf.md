---
id: VARIABLE-CALICO_NODE_IGNORELOOSERPF
type: variable
title: calico_node_ignorelooserpf
status: active
...
Kubespray variable `calico_node_ignorelooserpf` — default `false`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
