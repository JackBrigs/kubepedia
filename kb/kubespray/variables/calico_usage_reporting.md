---
id: VARIABLE-CALICO_USAGE_REPORTING
type: variable
title: calico_usage_reporting
status: active
...
Kubespray variable `calico_usage_reporting` — default `false`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
