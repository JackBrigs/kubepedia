---
id: VARIABLE-CALICO_IPAM_HOST_LOCAL
type: variable
title: calico_ipam_host_local
status: active
...
Kubespray variable `calico_ipam_host_local` — default `false`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
