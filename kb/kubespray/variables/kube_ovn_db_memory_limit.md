---
id: VARIABLE-KUBE_OVN_DB_MEMORY_LIMIT
type: variable
title: kube_ovn_db_memory_limit
status: active
...
Kubespray variable `kube_ovn_db_memory_limit` — default `3000Mi`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
