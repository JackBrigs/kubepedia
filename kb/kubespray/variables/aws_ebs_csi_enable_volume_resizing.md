---
id: VARIABLE-AWS_EBS_CSI_ENABLE_VOLUME_RESIZING
type: variable
title: aws_ebs_csi_enable_volume_resizing
status: active
...
confidence: verified
aliases:
  - aws_ebs_csi_enable_volume_resizing
tags:
  - kubernetes-apps
  - csi-driver
  - variable
...
Kubespray variable `aws_ebs_csi_enable_volume_resizing` — default `false`. Defined in `roles/kubernetes-apps/csi_driver/aws_ebs/defaults/main.yml`. Present in Kubespray
