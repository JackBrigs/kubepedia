---
id: VARIABLE-CALICO_FELIX_CHAININSERTMODE
type: variable
title: calico_felix_chaininsertmode
status: active
...
Kubespray variable `calico_felix_chaininsertmode` — default `Insert`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
