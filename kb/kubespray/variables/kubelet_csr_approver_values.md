---
id: VARIABLE-KUBELET_CSR_APPROVER_VALUES
type: variable
title: kubelet_csr_approver_values
status: active
...
Kubespray variable `kubelet_csr_approver_values` — default `{}`. Defined in `roles/kubernetes-apps/kubelet-csr-approver/defaults/main.yml`. Present in Kubespray
