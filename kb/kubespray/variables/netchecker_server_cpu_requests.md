---
id: VARIABLE-NETCHECKER_SERVER_CPU_REQUESTS
type: variable
title: netchecker_server_cpu_requests
status: active
...
confidence: verified
aliases:
  - netchecker_server_cpu_requests
tags:
  - kubernetes-apps
  - ansible
  - variable
...
Kubespray variable `netchecker_server_cpu_requests` — default `50m`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
