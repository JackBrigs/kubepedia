---
id: VARIABLE-DNS_AUTOSCALER_MEMORY_REQUESTS
type: variable
title: dns_autoscaler_memory_requests
status: active
...
Kubespray variable `dns_autoscaler_memory_requests` — default `10Mi`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
