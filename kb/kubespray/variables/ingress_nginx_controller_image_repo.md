---
id: VARIABLE-INGRESS_NGINX_CONTROLLER_IMAGE_REPO
type: variable
title: ingress_nginx_controller_image_repo
status: active
...
sources:
  - type: code
    ...
    note: "default: {{ kube_image_repo }}/ingress-nginx/controller"
relations: []
---
...
Kubespray variable `ingress_nginx_controller_image_repo` — default `{{ kube_image_repo }}/ingress-nginx/controller`. Defined in `roles/kubespray_defaults/defaults/main/download.yml`. Present in Kubespray
