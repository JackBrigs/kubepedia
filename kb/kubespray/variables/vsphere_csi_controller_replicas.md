---
id: VARIABLE-VSPHERE_CSI_CONTROLLER_REPLICAS
type: variable
title: vsphere_csi_controller_replicas
status: active
...
confidence: verified
aliases:
  - vsphere_csi_controller_replicas
tags:
  - kubernetes-apps
  - csi-driver
  - variable
...
Kubespray variable `vsphere_csi_controller_replicas` — default `1`. Defined in `roles/kubernetes-apps/csi_driver/vsphere/defaults/main.yml`. Present in Kubespray
