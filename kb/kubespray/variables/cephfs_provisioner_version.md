---
id: VARIABLE-CEPHFS_PROVISIONER_VERSION
type: variable
title: cephfs_provisioner_version
status: active
...
Kubespray variable `cephfs_provisioner_version` — default `v2.1.0-k8s1.11`. Defined in `roles/kubespray-defaults/defaults/main/download.yml`. Present in Kubespray
