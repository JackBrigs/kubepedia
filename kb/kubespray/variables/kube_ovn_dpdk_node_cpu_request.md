---
id: VARIABLE-KUBE_OVN_DPDK_NODE_CPU_REQUEST
type: variable
title: kube_ovn_dpdk_node_cpu_request
status: active
...
confidence: verified
aliases:
  - kube_ovn_dpdk_node_cpu_request
tags:
  - network-plugin
  - kube-ovn
  - variable
...
Kubespray variable `kube_ovn_dpdk_node_cpu_request` — default `1000m`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
