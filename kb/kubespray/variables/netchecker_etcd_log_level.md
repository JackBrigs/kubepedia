---
id: VARIABLE-NETCHECKER_ETCD_LOG_LEVEL
type: variable
title: netchecker_etcd_log_level
status: active
...
Kubespray variable `netchecker_etcd_log_level` — default `info`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
