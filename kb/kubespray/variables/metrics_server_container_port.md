---
id: VARIABLE-METRICS_SERVER_CONTAINER_PORT
type: variable
title: metrics_server_container_port
status: active
...
Kubespray variable `metrics_server_container_port` — default `10250`. Defined in `roles/kubernetes-apps/metrics_server/defaults/main.yml`. Present in Kubespray
