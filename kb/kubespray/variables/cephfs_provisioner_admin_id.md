---
id: VARIABLE-CEPHFS_PROVISIONER_ADMIN_ID
type: variable
title: cephfs_provisioner_admin_id
status: active
...
Kubespray variable `cephfs_provisioner_admin_id` — default `admin`. Defined in `roles/kubernetes-apps/external_provisioner/cephfs_provisioner/defaults/main.yml`. Present in Kubespray
