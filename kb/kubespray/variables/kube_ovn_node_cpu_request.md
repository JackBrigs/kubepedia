---
id: VARIABLE-KUBE_OVN_NODE_CPU_REQUEST
type: variable
title: kube_ovn_node_cpu_request
status: active
...
Kubespray variable `kube_ovn_node_cpu_request` — default `200m`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
