---
id: VARIABLE-CALICO_BGP_LISTEN_PORT
type: variable
title: calico_bgp_listen_port
status: active
...
Kubespray variable `calico_bgp_listen_port` — default `179`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
