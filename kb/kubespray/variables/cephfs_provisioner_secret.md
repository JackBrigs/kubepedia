---
id: VARIABLE-CEPHFS_PROVISIONER_SECRET
type: variable
title: cephfs_provisioner_secret
status: active
...
Kubespray variable `cephfs_provisioner_secret` — default `secret`. Defined in `roles/kubernetes-apps/external_provisioner/cephfs_provisioner/defaults/main.yml`. Present in Kubespray
