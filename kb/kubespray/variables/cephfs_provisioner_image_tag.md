---
id: VARIABLE-CEPHFS_PROVISIONER_IMAGE_TAG
type: variable
title: cephfs_provisioner_image_tag
status: active
...
sources:
  - type: code
    ...
    note: "default: {{ cephfs_provisioner_version }}"
relations: []
---
...
Kubespray variable `cephfs_provisioner_image_tag` — default `{{ cephfs_provisioner_version }}`. Defined in `roles/kubespray-defaults/defaults/main/download.yml`. Present in Kubespray
