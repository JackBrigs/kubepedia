---
id: VARIABLE-NETCHECKER_PORT
type: variable
title: netchecker_port
status: active
...
Kubespray variable `netchecker_port` — default `31081`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
