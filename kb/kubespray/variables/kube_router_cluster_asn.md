---
id: VARIABLE-KUBE_ROUTER_CLUSTER_ASN
type: variable
title: kube_router_cluster_asn
status: active
...
Kubespray variable `kube_router_cluster_asn` — default `~`. Defined in `roles/network_plugin/kube-router/defaults/main.yml`. Present in Kubespray
