---
id: VARIABLE-CERT_MANAGER_LEADER_ELECTION_NAMESPACE
type: variable
title: cert_manager_leader_election_namespace
status: active
...
confidence: verified
aliases:
  - cert_manager_leader_election_namespace
tags:
  - kubernetes-apps
  - ingress-controller
  - variable
...
Kubespray variable `cert_manager_leader_election_namespace` — default `kube-system`. Defined in `roles/kubernetes-apps/ingress_controller/cert_manager/defaults/main.yml`. Present in Kubespray
