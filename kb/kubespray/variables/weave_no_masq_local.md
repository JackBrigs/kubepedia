---
id: VARIABLE-WEAVE_NO_MASQ_LOCAL
type: variable
title: weave_no_masq_local
status: active
...
Kubespray variable `weave_no_masq_local` — default `true`. Defined in `roles/network_plugin/weave/defaults/main.yml`. Present in Kubespray
