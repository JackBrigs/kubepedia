---
id: VARIABLE-UPCLOUD_CSI_CONTROLLER_REPLICAS
type: variable
title: upcloud_csi_controller_replicas
status: active
...
confidence: verified
aliases:
  - upcloud_csi_controller_replicas
tags:
  - kubernetes-apps
  - csi-driver
  - variable
...
Kubespray variable `upcloud_csi_controller_replicas` — default `1`. Defined in `roles/kubernetes-apps/csi_driver/upcloud/defaults/main.yml`. Present in Kubespray
