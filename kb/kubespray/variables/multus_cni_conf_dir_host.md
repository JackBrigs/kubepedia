---
id: VARIABLE-MULTUS_CNI_CONF_DIR_HOST
type: variable
title: multus_cni_conf_dir_host
status: active
...
Kubespray variable `multus_cni_conf_dir_host` — default `/etc/cni/net.d`. Defined in `roles/network_plugin/multus/defaults/main.yml`. Present in Kubespray
