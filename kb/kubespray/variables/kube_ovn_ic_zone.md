---
id: VARIABLE-KUBE_OVN_IC_ZONE
type: variable
title: kube_ovn_ic_zone
status: active
...
Kubespray variable `kube_ovn_ic_zone` — default `kubernetes`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
