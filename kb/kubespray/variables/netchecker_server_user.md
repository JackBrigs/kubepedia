---
id: VARIABLE-NETCHECKER_SERVER_USER
type: variable
title: netchecker_server_user
status: active
...
Kubespray variable `netchecker_server_user` — default `1000`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
