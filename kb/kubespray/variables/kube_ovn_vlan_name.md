---
id: VARIABLE-KUBE_OVN_VLAN_NAME
type: variable
title: kube_ovn_vlan_name
status: active
...
Kubespray variable `kube_ovn_vlan_name` — default `product`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
