---
id: VARIABLE-KUBE_OVN_CNI_SERVER_CPU_REQUEST
type: variable
title: kube_ovn_cni_server_cpu_request
status: active
...
confidence: verified
aliases:
  - kube_ovn_cni_server_cpu_request
tags:
  - network-plugin
  - kube-ovn
  - variable
...
Kubespray variable `kube_ovn_cni_server_cpu_request` — default `200m`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
