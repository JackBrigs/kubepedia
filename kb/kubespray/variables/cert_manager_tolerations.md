---
id: VARIABLE-CERT_MANAGER_TOLERATIONS
type: variable
title: cert_manager_tolerations
status: active
...
Kubespray variable `cert_manager_tolerations` — default `[]`. Defined in `roles/kubernetes-apps/ingress_controller/cert_manager/defaults/main.yml`. Present in Kubespray
