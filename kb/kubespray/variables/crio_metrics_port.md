---
id: VARIABLE-CRIO_METRICS_PORT
type: variable
title: crio_metrics_port
status: active
...
Kubespray variable `crio_metrics_port` — default `9090`. Defined in `roles/container-engine/cri-o/defaults/main.yml`. Present in Kubespray
