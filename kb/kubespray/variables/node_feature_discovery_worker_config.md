---
id: VARIABLE-NODE_FEATURE_DISCOVERY_WORKER_CONFIG
type: variable
title: node_feature_discovery_worker_config
status: active
...
confidence: verified
aliases:
  - node_feature_discovery_worker_config
tags:
  - kubernetes-apps
...
Kubespray variable `node_feature_discovery_worker_config` — default `null`. Defined in `roles/kubernetes-apps/node_feature_discovery/defaults/main.yml`. Present in Kubespray
