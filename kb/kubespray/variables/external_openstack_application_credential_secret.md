---
id: VARIABLE-EXTERNAL_OPENSTACK_APPLICATION_CREDENTIAL_SECRET
type: variable
title: external_openstack_application_credential_secret
status: active
...
Kubespray variable `external_openstack_application_credential_secret` — default `{{ lookup('env', 'OS_APPLICATION_CREDENTIAL_SECRET') }}`. Defined in `roles/kubernetes-apps/external_cloud_controller/openstack/defaults/main.yml`. Present in Kubespray
