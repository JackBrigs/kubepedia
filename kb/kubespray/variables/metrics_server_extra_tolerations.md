---
id: VARIABLE-METRICS_SERVER_EXTRA_TOLERATIONS
type: variable
title: metrics_server_extra_tolerations
status: active
...
Kubespray variable `metrics_server_extra_tolerations` — default `[]`. Defined in `roles/kubernetes-apps/metrics_server/defaults/main.yml`. Present in Kubespray
