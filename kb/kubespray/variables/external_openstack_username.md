---
id: VARIABLE-EXTERNAL_OPENSTACK_USERNAME
type: variable
title: external_openstack_username
status: active
...
sources:
  - type: code
    ...
    note: "default: {{ lookup('env', 'OS_USERNAME') }}"
relations: []
---
...
Kubespray variable `external_openstack_username` — default `{{ lookup('env', 'OS_USERNAME') }}`. Defined in `roles/kubernetes-apps/external_cloud_controller/openstack/defaults/main.yml`. Present in Kubespray
