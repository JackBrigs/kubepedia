---
id: VARIABLE-DNS_MIN_REPLICAS
type: variable
title: dns_min_replicas
status: active
...
sources:
  - type: code
    ...
    note: "default: {{ [2, groups['k8s_cluster'] | length] | min }}"
relations: []
---
...
Kubespray variable `dns_min_replicas` — default `{{ [2, groups['k8s_cluster'] | length] | min }}`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
