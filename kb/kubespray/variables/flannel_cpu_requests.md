---
id: VARIABLE-FLANNEL_CPU_REQUESTS
type: variable
title: flannel_cpu_requests
status: active
...
Kubespray variable `flannel_cpu_requests` — default `150m`. Defined in `roles/network_plugin/flannel/defaults/main.yml`. Present in Kubespray
