---
id: VARIABLE-KUBE_OVN_TRAFFIC_MIRROR
type: variable
title: kube_ovn_traffic_mirror
status: active
...
Kubespray variable `kube_ovn_traffic_mirror` — default `false`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
