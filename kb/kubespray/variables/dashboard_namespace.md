---
id: VARIABLE-DASHBOARD_NAMESPACE
type: variable
title: dashboard_namespace
status: active
...
Kubespray variable `dashboard_namespace` — default `kube-system`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
