---
id: VARIABLE-WEAVE_METRICS_ADDR
type: variable
title: weave_metrics_addr
status: active
...
Kubespray variable `weave_metrics_addr` — default `~`. Defined in `roles/network_plugin/weave/defaults/main.yml`. Present in Kubespray
