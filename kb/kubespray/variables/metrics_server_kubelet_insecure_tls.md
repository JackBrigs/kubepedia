---
id: VARIABLE-METRICS_SERVER_KUBELET_INSECURE_TLS
type: variable
title: metrics_server_kubelet_insecure_tls
status: active
...
Kubespray variable `metrics_server_kubelet_insecure_tls` — default `true`. Defined in `roles/kubernetes-apps/metrics_server/defaults/main.yml`. Present in Kubespray
