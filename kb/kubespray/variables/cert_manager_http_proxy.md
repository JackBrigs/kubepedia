---
id: VARIABLE-CERT_MANAGER_HTTP_PROXY
type: variable
title: cert_manager_http_proxy
status: active
...
sources:
  - type: code
    ...
    note: "default: {{ http_proxy | default('') }}"
relations: []
---
...
Kubespray variable `cert_manager_http_proxy` — default `{{ http_proxy | default('') }}`. Defined in `roles/kubernetes-apps/ingress_controller/cert_manager/defaults/main.yml`. Present in Kubespray
