---
id: VARIABLE-EXTERNAL_ORACLE_LOAD_BALANCER_SUBNET1
type: variable
title: external_oracle_load_balancer_subnet1
status: active
...
Kubespray variable `external_oracle_load_balancer_subnet1` — default `(empty)`. Defined in `roles/kubernetes-apps/external_cloud_controller/oci/defaults/main.yml`. Present in Kubespray
...
```yaml
external_oracle_load_balancer_subnet1: (empty)
```
