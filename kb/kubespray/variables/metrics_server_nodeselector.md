---
id: VARIABLE-METRICS_SERVER_NODESELECTOR
type: variable
title: metrics_server_nodeselector
status: active
...
Kubespray variable `metrics_server_nodeselector` — default `{}`. Defined in `roles/kubernetes-apps/metrics_server/defaults/main.yml`. Present in Kubespray
