---
id: VARIABLE-NETCHECKER_SERVER_LOG_LEVEL
type: variable
title: netchecker_server_log_level
status: active
...
Kubespray variable `netchecker_server_log_level` — default `5`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
