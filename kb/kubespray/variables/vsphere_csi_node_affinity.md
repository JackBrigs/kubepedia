---
id: VARIABLE-VSPHERE_CSI_NODE_AFFINITY
type: variable
title: vsphere_csi_node_affinity
status: active
...
Kubespray variable `vsphere_csi_node_affinity` — default `{}`. Defined in `roles/kubernetes-apps/csi_driver/vsphere/defaults/main.yml`. Present in Kubespray
