---
id: VARIABLE-UPCLOUD_TOLERATIONS
type: variable
title: upcloud_tolerations
status: active
...
Kubespray variable `upcloud_tolerations` — default `[]`. Defined in `roles/kubernetes-apps/csi_driver/upcloud/defaults/main.yml`. Present in Kubespray
