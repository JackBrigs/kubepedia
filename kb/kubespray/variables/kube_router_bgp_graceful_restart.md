---
id: VARIABLE-KUBE_ROUTER_BGP_GRACEFUL_RESTART
type: variable
title: kube_router_bgp_graceful_restart
status: active
...
Kubespray variable `kube_router_bgp_graceful_restart` — default `true`. Defined in `roles/network_plugin/kube-router/defaults/main.yml`. Present in Kubespray
