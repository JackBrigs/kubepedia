---
id: VARIABLE-DOCKER_DEBIAN_REPO_REPOKEY
type: variable
title: docker_debian_repo_repokey
status: active
...
## Summary
Fingerprint of the Docker APT repository signing key on Debian hosts. Defaults to `9DC858229FC7DD38854AE2D88D81803C0EBFCD88`.
...
## Compatibility
Kubespray v2.29.0 through v2.31.0. Applies on Debian when Docker is the selected container engine. Related: `docker_debian_repo_base_url`, `docker_debian_repo_gpgkey`.
