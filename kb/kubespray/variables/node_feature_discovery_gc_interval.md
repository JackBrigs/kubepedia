---
id: VARIABLE-NODE_FEATURE_DISCOVERY_GC_INTERVAL
type: variable
title: node_feature_discovery_gc_interval
status: active
...
confidence: verified
aliases:
  - node_feature_discovery_gc_interval
tags:
  - kubernetes-apps
...
Kubespray variable `node_feature_discovery_gc_interval` — default `1h`. Defined in `roles/kubernetes-apps/node_feature_discovery/defaults/main.yml`. Present in Kubespray
