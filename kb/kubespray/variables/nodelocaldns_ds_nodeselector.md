---
id: VARIABLE-NODELOCALDNS_DS_NODESELECTOR
type: variable
title: nodelocaldns_ds_nodeselector
status: active
...
Kubespray variable `nodelocaldns_ds_nodeselector` — default `kubernetes.io/os: linux`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
