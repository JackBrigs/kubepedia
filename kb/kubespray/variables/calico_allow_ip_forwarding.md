---
id: VARIABLE-CALICO_ALLOW_IP_FORWARDING
type: variable
title: calico_allow_ip_forwarding
status: active
...
Kubespray variable `calico_allow_ip_forwarding` — default `false`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
