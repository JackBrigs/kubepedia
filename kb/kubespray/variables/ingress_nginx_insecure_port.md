---
id: VARIABLE-INGRESS_NGINX_INSECURE_PORT
type: variable
title: ingress_nginx_insecure_port
status: active
...
Kubespray variable `ingress_nginx_insecure_port` — default `80`. Defined in `roles/kubernetes-apps/ingress_controller/ingress_nginx/defaults/main.yml`. Present in Kubespray
