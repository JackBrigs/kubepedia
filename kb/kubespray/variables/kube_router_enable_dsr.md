---
id: VARIABLE-KUBE_ROUTER_ENABLE_DSR
type: variable
title: kube_router_enable_dsr
status: active
...
Kubespray variable `kube_router_enable_dsr` — default `false`. Defined in `roles/network_plugin/kube-router/defaults/main.yml`. Present in Kubespray
