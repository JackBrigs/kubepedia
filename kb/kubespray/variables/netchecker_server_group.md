---
id: VARIABLE-NETCHECKER_SERVER_GROUP
type: variable
title: netchecker_server_group
status: active
...
Kubespray variable `netchecker_server_group` — default `1000`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
