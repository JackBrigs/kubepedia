---
id: VARIABLE-RBD_PROVISIONER_SECRET
type: variable
title: rbd_provisioner_secret
status: active
...
Kubespray variable `rbd_provisioner_secret` — default `ceph-key-admin`. Defined in `roles/kubernetes-apps/external_provisioner/rbd_provisioner/defaults/main.yml`. Present in Kubespray
