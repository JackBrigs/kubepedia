---
id: VARIABLE-NETCHECK_VERSION
type: variable
title: netcheck_version
status: active
...
Kubespray variable `netcheck_version` — default `1.2.2`. Defined in `roles/kubespray_defaults/defaults/main/download.yml`. Present in Kubespray
