---
id: VARIABLE-KUBE_OVN_U2O_INTERCONNECTION
type: variable
title: kube_ovn_u2o_interconnection
status: active
...
Kubespray variable `kube_ovn_u2o_interconnection` — default `false`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
