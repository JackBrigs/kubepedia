---
id: VARIABLE-DNS_MEMORY_LIMIT
type: variable
title: dns_memory_limit
status: active
...
Kubespray variable `dns_memory_limit` — default `300Mi`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
