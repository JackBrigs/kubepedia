---
id: VARIABLE-CINDER_CSI_CONTROLLER_REPLICAS
type: variable
title: cinder_csi_controller_replicas
status: active
...
confidence: verified
aliases:
  - cinder_csi_controller_replicas
tags:
  - kubernetes-apps
  - csi-driver
  - variable
...
Kubespray variable `cinder_csi_controller_replicas` — default `1`. Defined in `roles/kubernetes-apps/csi_driver/cinder/defaults/main.yml`. Present in Kubespray
