---
id: VARIABLE-KUBELET_CSR_APPROVER_CHART_REF
type: variable
title: kubelet_csr_approver_chart_ref
status: active
...
sources:
  - type: code
    ...
    note: "default: {{ kubelet_csr_approver_repository_name }}/kubelet-csr-approver"
relations: []
---
...
Kubespray variable `kubelet_csr_approver_chart_ref` — default `{{ kubelet_csr_approver_repository_name }}/kubelet-csr-approver`. Defined in `roles/kubernetes-apps/kubelet-csr-approver/defaults/main.yml`. Present in Kubespray
