---
id: VARIABLE-UPCLOUD_CSI_SNAPSHOT_CONTROLLER_IMAGE_TAG
type: variable
title: upcloud_csi_snapshot_controller_image_tag
status: active
...
confidence: verified
aliases:
  - upcloud_csi_snapshot_controller_image_tag
tags:
  - kubernetes-apps
  - csi-driver
  - variable
...
Kubespray variable `upcloud_csi_snapshot_controller_image_tag` — default `v4.2.1`. Defined in `roles/kubernetes-apps/csi_driver/upcloud/defaults/main.yml`. Present in Kubespray
