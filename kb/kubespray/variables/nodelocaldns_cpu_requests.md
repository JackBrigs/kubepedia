---
id: VARIABLE-NODELOCALDNS_CPU_REQUESTS
type: variable
title: nodelocaldns_cpu_requests
status: active
...
Kubespray variable `nodelocaldns_cpu_requests` — default `100m`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
