---
id: VARIABLE-RBD_PROVISIONER_STORAGE_CLASS
type: variable
title: rbd_provisioner_storage_class
status: active
...
Kubespray variable `rbd_provisioner_storage_class` — default `rbd`. Defined in `roles/kubernetes-apps/external_provisioner/rbd_provisioner/defaults/main.yml`. Present in Kubespray
