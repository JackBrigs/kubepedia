---
id: VARIABLE-KUBE_ROUTER_ANNOTATIONS_NODE
type: variable
title: kube_router_annotations_node
status: active
...
Kubespray variable `kube_router_annotations_node` — default `[]`. Defined in `roles/network_plugin/kube-router/defaults/main.yml`. Present in Kubespray
