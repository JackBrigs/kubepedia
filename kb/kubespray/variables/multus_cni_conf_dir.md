---
id: VARIABLE-MULTUS_CNI_CONF_DIR
type: variable
title: multus_cni_conf_dir
status: active
...
sources:
  - type: code
    ...
    note: "default: {{ ('/host', multus_cni_conf_dir_host) | join }}"
relations: []
---
...
Kubespray variable `multus_cni_conf_dir` — default `{{ ('/host', multus_cni_conf_dir_host) | join }}`. Defined in `roles/network_plugin/multus/defaults/main.yml`. Present in Kubespray
