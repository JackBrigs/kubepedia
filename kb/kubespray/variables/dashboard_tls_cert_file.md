---
id: VARIABLE-DASHBOARD_TLS_CERT_FILE
type: variable
title: dashboard_tls_cert_file
status: active
...
Kubespray variable `dashboard_tls_cert_file` — default `dashboard.crt`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
