---
id: VARIABLE-CALICO_VXLAN_VNI
type: variable
title: calico_vxlan_vni
status: active
...
Kubespray variable `calico_vxlan_vni` — default `4096`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
