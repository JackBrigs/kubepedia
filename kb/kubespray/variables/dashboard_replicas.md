---
id: VARIABLE-DASHBOARD_REPLICAS
type: variable
title: dashboard_replicas
status: active
...
Kubespray variable `dashboard_replicas` — default `1`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
