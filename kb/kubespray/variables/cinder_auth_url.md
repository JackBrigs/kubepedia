---
id: VARIABLE-CINDER_AUTH_URL
type: variable
title: cinder_auth_url
status: active
...
Kubespray variable `cinder_auth_url` — default `{{ lookup('env', 'OS_AUTH_URL') }}`. Defined in `roles/kubernetes-apps/csi_driver/cinder/defaults/main.yml`. Present in Kubespray
