---
id: VARIABLE-CALICO_NODE_CPU_LIMIT
type: variable
title: calico_node_cpu_limit
status: active
...
Kubespray variable `calico_node_cpu_limit` — default `0`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
