---
id: VARIABLE-KUBE_OVN_DPDK_ENABLED
type: variable
title: kube_ovn_dpdk_enabled
status: active
...
Kubespray variable `kube_ovn_dpdk_enabled` — default `false`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
