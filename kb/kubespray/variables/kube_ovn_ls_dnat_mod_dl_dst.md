---
id: VARIABLE-KUBE_OVN_LS_DNAT_MOD_DL_DST
type: variable
title: kube_ovn_ls_dnat_mod_dl_dst
status: active
...
Kubespray variable `kube_ovn_ls_dnat_mod_dl_dst` — default `true`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
