---
id: VARIABLE-CALICO_IPAM_STRICTAFFINITY
type: variable
title: calico_ipam_strictaffinity
status: active
...
Kubespray variable `calico_ipam_strictaffinity` — default `false`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
