---
id: VARIABLE-KUBE_ROUTER_ENABLE_METRICS
type: variable
title: kube_router_enable_metrics
status: active
...
Kubespray variable `kube_router_enable_metrics` — default `false`. Defined in `roles/network_plugin/kube-router/defaults/main.yml`. Present in Kubespray
