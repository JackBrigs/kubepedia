---
id: VARIABLE-KUBE_OVN_DEFAULT_GATEWAY_CHECK
type: variable
title: kube_ovn_default_gateway_check
status: active
...
confidence: verified
aliases:
  - kube_ovn_default_gateway_check
tags:
  - network-plugin
  - kube-ovn
  - variable
...
Kubespray variable `kube_ovn_default_gateway_check` — default `true`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
