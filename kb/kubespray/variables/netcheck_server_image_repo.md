---
id: VARIABLE-NETCHECK_SERVER_IMAGE_REPO
type: variable
title: netcheck_server_image_repo
status: active
...
sources:
  - type: code
    ...
    note: "default: {{ docker_image_repo }}/mirantis/k8s-netchecker-server"
relations: []
---
...
Kubespray variable `netcheck_server_image_repo` — default `{{ docker_image_repo }}/mirantis/k8s-netchecker-server`. Defined in `roles/kubespray_defaults/defaults/main/download.yml`. Present in Kubespray
