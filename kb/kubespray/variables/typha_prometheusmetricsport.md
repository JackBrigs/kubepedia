---
id: VARIABLE-TYPHA_PROMETHEUSMETRICSPORT
type: variable
title: typha_prometheusmetricsport
status: active
...
Kubespray variable `typha_prometheusmetricsport` — default `9093`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
