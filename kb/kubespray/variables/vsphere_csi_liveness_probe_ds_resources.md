---
id: VARIABLE-VSPHERE_CSI_LIVENESS_PROBE_DS_RESOURCES
type: variable
title: vsphere_csi_liveness_probe_ds_resources
status: active
...
Kubespray variable `vsphere_csi_liveness_probe_ds_resources` — default `{}`. Defined in `roles/kubernetes-apps/csi_driver/vsphere/defaults/main.yml`. Present in Kubespray
