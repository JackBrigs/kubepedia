---
id: VARIABLE-RBD_PROVISIONER_FS_TYPE
type: variable
title: rbd_provisioner_fs_type
status: active
...
Kubespray variable `rbd_provisioner_fs_type` — default `ext4`. Defined in `roles/kubernetes-apps/external_provisioner/rbd_provisioner/defaults/main.yml`. Present in Kubespray
