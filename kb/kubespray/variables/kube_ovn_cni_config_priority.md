---
id: VARIABLE-KUBE_OVN_CNI_CONFIG_PRIORITY
type: variable
title: kube_ovn_cni_config_priority
status: active
...
Kubespray variable `kube_ovn_cni_config_priority` — default `01`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
