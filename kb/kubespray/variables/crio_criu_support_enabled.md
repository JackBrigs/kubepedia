---
id: VARIABLE-CRIO_CRIU_SUPPORT_ENABLED
type: variable
title: crio_criu_support_enabled
status: active
...
Kubespray variable `crio_criu_support_enabled` — default `false`. Defined in `roles/container-engine/cri-o/defaults/main.yml`. Present in Kubespray
