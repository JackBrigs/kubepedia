---
id: VARIABLE-CINDER_LIVENESS_PROBE_EXTRA_ARGS
type: variable
title: cinder_liveness_probe_extra_args
status: active
...
Kubespray variable `cinder_liveness_probe_extra_args` — default `{}`. Defined in `roles/kubernetes-apps/csi_driver/cinder/defaults/main.yml`. Present in Kubespray
