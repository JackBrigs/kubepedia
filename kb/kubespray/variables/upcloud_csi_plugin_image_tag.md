---
id: VARIABLE-UPCLOUD_CSI_PLUGIN_IMAGE_TAG
type: variable
title: upcloud_csi_plugin_image_tag
status: active
...
Kubespray variable `upcloud_csi_plugin_image_tag` — default `v1.1.0`. Defined in `roles/kubernetes-apps/csi_driver/upcloud/defaults/main.yml`. Present in Kubespray
