---
id: VARIABLE-CALICO_FELIX_FLOATING_IPS
type: variable
title: calico_felix_floating_ips
status: active
...
Kubespray variable `calico_felix_floating_ips` — default `Disabled`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
