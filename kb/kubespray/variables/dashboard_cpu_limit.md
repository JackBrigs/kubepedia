---
id: VARIABLE-DASHBOARD_CPU_LIMIT
type: variable
title: dashboard_cpu_limit
status: active
...
Kubespray variable `dashboard_cpu_limit` — default `100m`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
