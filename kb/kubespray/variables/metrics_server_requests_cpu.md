---
id: VARIABLE-METRICS_SERVER_REQUESTS_CPU
type: variable
title: metrics_server_requests_cpu
status: active
...
Kubespray variable `metrics_server_requests_cpu` — default `100m`. Defined in `roles/kubernetes-apps/metrics_server/defaults/main.yml`. Present in Kubespray
