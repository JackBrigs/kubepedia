---
id: VARIABLE-SKIP_HTTP_PROXY_ON_OS_PACKAGES
type: variable
title: skip_http_proxy_on_os_packages
status: active
...
confidence: verified
aliases:
  - skip_http_proxy_on_os_packages
tags:
  - bootstrap-os
  - variable
sources:
...
Kubespray variable `skip_http_proxy_on_os_packages` — default `false`. Defined in `roles/bootstrap_os/defaults/main.yml`. Present in Kubespray
