---
id: VARIABLE-INGRESS_NGINX_WITHOUT_CLASS
type: variable
title: ingress_nginx_without_class
status: active
...
Kubespray variable `ingress_nginx_without_class` — default `true`. Defined in `roles/kubernetes-apps/ingress_controller/ingress_nginx/defaults/main.yml`. Present in Kubespray
