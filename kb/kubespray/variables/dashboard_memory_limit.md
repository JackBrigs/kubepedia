---
id: VARIABLE-DASHBOARD_MEMORY_LIMIT
type: variable
title: dashboard_memory_limit
status: active
...
Kubespray variable `dashboard_memory_limit` — default `256M`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
