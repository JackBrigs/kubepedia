---
id: VARIABLE-KUBE_OVN_DPDK_NODE_CPU_LIMIT
type: variable
title: kube_ovn_dpdk_node_cpu_limit
status: active
...
Kubespray variable `kube_ovn_dpdk_node_cpu_limit` — default `1000m`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
