---
id: VARIABLE-NVIDIA_GPU_FLAVOR
type: variable
title: nvidia_gpu_flavor
status: active
...
Kubespray variable `nvidia_gpu_flavor` — default `tesla`. Defined in `roles/kubernetes-apps/container_engine_accelerator/nvidia_gpu/defaults/main.yml`. Present in Kubespray
