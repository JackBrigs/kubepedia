---
id: VARIABLE-KUBE_OVN_MONITOR_MEMORY_LIMIT
type: variable
title: kube_ovn_monitor_memory_limit
status: active
...
Kubespray variable `kube_ovn_monitor_memory_limit` — default `200Mi`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
