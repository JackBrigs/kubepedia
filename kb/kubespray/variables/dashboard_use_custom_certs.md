---
id: VARIABLE-DASHBOARD_USE_CUSTOM_CERTS
type: variable
title: dashboard_use_custom_certs
status: active
...
Kubespray variable `dashboard_use_custom_certs` — default `false`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
