---
id: VARIABLE-RBD_PROVISIONER_IMAGE_FORMAT
type: variable
title: rbd_provisioner_image_format
status: active
...
Kubespray variable `rbd_provisioner_image_format` — default `2`. Defined in `roles/kubernetes-apps/external_provisioner/rbd_provisioner/defaults/main.yml`. Present in Kubespray
