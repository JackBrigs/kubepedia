---
id: VARIABLE-INGRESS_NGINX_CONFIGMAP_UDP_SERVICES
type: variable
title: ingress_nginx_configmap_udp_services
status: active
...
Kubespray variable `ingress_nginx_configmap_udp_services` — default `{}`. Defined in `roles/kubernetes-apps/ingress_controller/ingress_nginx/defaults/main.yml`. Present in Kubespray
