---
id: VARIABLE-CINDER_CSI_ATTACHER_EXTRA_ARGS
type: variable
title: cinder_csi_attacher_extra_args
status: active
...
Kubespray variable `cinder_csi_attacher_extra_args` — default `{}`. Defined in `roles/kubernetes-apps/csi_driver/cinder/defaults/main.yml`. Present in Kubespray
