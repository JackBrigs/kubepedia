---
id: VARIABLE-MULTUS_CNI_RUN_DIR_HOST
type: variable
title: multus_cni_run_dir_host
status: active
...
Kubespray variable `multus_cni_run_dir_host` — default `/run`. Defined in `roles/network_plugin/multus/defaults/main.yml`. Present in Kubespray
