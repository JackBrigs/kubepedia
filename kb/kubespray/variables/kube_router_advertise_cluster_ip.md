---
id: VARIABLE-KUBE_ROUTER_ADVERTISE_CLUSTER_IP
type: variable
title: kube_router_advertise_cluster_ip
status: active
...
confidence: verified
aliases:
  - kube_router_advertise_cluster_ip
tags:
  - network-plugin
  - kube-router
  - variable
...
Kubespray variable `kube_router_advertise_cluster_ip` — default `false`. Defined in `roles/network_plugin/kube-router/defaults/main.yml`. Present in Kubespray
