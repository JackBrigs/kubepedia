---
id: VARIABLE-KUBE_ROUTER_DNS_POLICY
type: variable
title: kube_router_dns_policy
status: active
...
sources:
  - type: code
    ...
    note: "default: ClusterFirstWithHostNet"
relations: []
---
...
Kubespray variable `kube_router_dns_policy` — default `ClusterFirstWithHostNet`. Defined in `roles/network_plugin/kube-router/defaults/main.yml`. Present in Kubespray
