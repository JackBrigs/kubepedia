---
id: VARIABLE-DNS_AUTOSCALER_CPU_REQUESTS
type: variable
title: dns_autoscaler_cpu_requests
status: active
...
Kubespray variable `dns_autoscaler_cpu_requests` — default `20m`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
