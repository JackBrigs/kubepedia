---
id: VARIABLE-EXTERNAL_HUAWEICLOUD_AUTH_URL
type: variable
title: external_huaweicloud_auth_url
status: active
...
Kubespray variable `external_huaweicloud_auth_url` — default `{{ lookup('env', 'OS_AUTH_URL') }}`. Defined in `roles/kubernetes-apps/external_cloud_controller/huaweicloud/defaults/main.yml`. Present in Kubespray
