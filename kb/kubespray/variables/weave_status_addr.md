---
id: VARIABLE-WEAVE_STATUS_ADDR
type: variable
title: weave_status_addr
status: active
...
Kubespray variable `weave_status_addr` — default `~`. Defined in `roles/network_plugin/weave/defaults/main.yml`. Present in Kubespray
