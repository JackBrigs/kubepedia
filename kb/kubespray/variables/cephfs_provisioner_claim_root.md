---
id: VARIABLE-CEPHFS_PROVISIONER_CLAIM_ROOT
type: variable
title: cephfs_provisioner_claim_root
status: active
...
Kubespray variable `cephfs_provisioner_claim_root` — default `/volumes`. Defined in `roles/kubernetes-apps/external_provisioner/cephfs_provisioner/defaults/main.yml`. Present in Kubespray
