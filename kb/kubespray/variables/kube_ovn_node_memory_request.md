---
id: VARIABLE-KUBE_OVN_NODE_MEMORY_REQUEST
type: variable
title: kube_ovn_node_memory_request
status: active
...
Kubespray variable `kube_ovn_node_memory_request` — default `200Mi`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
