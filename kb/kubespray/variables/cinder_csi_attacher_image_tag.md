---
id: VARIABLE-CINDER_CSI_ATTACHER_IMAGE_TAG
type: variable
title: cinder_csi_attacher_image_tag
status: active
...
Kubespray variable `cinder_csi_attacher_image_tag` — default `v4.4.2`. Defined in `roles/kubernetes-apps/csi_driver/cinder/defaults/main.yml`. Present in Kubespray
