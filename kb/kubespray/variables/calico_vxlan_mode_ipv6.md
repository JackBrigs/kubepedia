---
id: VARIABLE-CALICO_VXLAN_MODE_IPV6
type: variable
title: calico_vxlan_mode_ipv6
status: active
...
Kubespray variable `calico_vxlan_mode_ipv6` — default `Always`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
