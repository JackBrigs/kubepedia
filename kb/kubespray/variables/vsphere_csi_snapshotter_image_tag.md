---
id: VARIABLE-VSPHERE_CSI_SNAPSHOTTER_IMAGE_TAG
type: variable
title: vsphere_csi_snapshotter_image_tag
status: active
...
confidence: verified
aliases:
  - vsphere_csi_snapshotter_image_tag
tags:
  - kubernetes-apps
  - csi-driver
  - variable
...
Kubespray variable `vsphere_csi_snapshotter_image_tag` — default `v6.2.2`. Defined in `roles/kubernetes-apps/csi_driver/vsphere/defaults/main.yml`. Present in Kubespray
