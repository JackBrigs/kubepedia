---
id: VARIABLE-KUBE_OVN_ENABLE_NP
type: variable
title: kube_ovn_enable_np
status: active
...
Kubespray variable `kube_ovn_enable_np` — default `true`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
