---
id: VARIABLE-NVIDIA_GPU_NODES
type: variable
title: nvidia_gpu_nodes
status: active
...
Kubespray variable `nvidia_gpu_nodes` — default `[]`. Defined in `roles/kubernetes-apps/container_engine_accelerator/nvidia_gpu/defaults/main.yml`. Present in Kubespray
