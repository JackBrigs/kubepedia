---
id: VARIABLE-EXTERNAL_VSPHERE_VCENTER_PORT
type: variable
title: external_vsphere_vcenter_port
status: active
...
Kubespray variable `external_vsphere_vcenter_port` — default `443`. Defined in `roles/kubernetes-apps/csi_driver/vsphere/defaults/main.yml`. Present in Kubespray
