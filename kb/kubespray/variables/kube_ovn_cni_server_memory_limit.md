---
id: VARIABLE-KUBE_OVN_CNI_SERVER_MEMORY_LIMIT
type: variable
title: kube_ovn_cni_server_memory_limit
status: active
...
confidence: verified
aliases:
  - kube_ovn_cni_server_memory_limit
tags:
  - network-plugin
  - kube-ovn
  - variable
...
Kubespray variable `kube_ovn_cni_server_memory_limit` — default `1Gi`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
