---
id: VARIABLE-INGRESS_NGINX_WEBHOOK_JOB_TTL
type: variable
title: ingress_nginx_webhook_job_ttl
status: active
...
Kubespray variable `ingress_nginx_webhook_job_ttl` — default `1800`. Defined in `roles/kubernetes-apps/ingress_controller/ingress_nginx/defaults/main.yml`. Present in Kubespray
