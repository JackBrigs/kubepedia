---
id: VARIABLE-GCP_PD_CSI_VOLUME_TYPE
type: variable
title: gcp_pd_csi_volume_type
status: active
...
Kubespray variable `gcp_pd_csi_volume_type` — default `pd-standard`. Defined in `roles/kubernetes-apps/persistent_volumes/gcp-pd-csi/defaults/main.yml`. Present in Kubespray
