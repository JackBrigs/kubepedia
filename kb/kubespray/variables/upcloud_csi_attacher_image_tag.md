---
id: VARIABLE-UPCLOUD_CSI_ATTACHER_IMAGE_TAG
type: variable
title: upcloud_csi_attacher_image_tag
status: active
...
confidence: verified
aliases:
  - upcloud_csi_attacher_image_tag
tags:
  - kubernetes-apps
  - csi-driver
  - variable
...
Kubespray variable `upcloud_csi_attacher_image_tag` — default `v3.4.0`. Defined in `roles/kubernetes-apps/csi_driver/upcloud/defaults/main.yml`. Present in Kubespray
