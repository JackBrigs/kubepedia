---
id: VARIABLE-UPCLOUD_CSI_PROVISIONER_IMAGE_TAG
type: variable
title: upcloud_csi_provisioner_image_tag
status: active
...
Kubespray variable `upcloud_csi_provisioner_image_tag` — default `v3.1.0`. Defined in `roles/kubernetes-apps/csi_driver/upcloud/defaults/main.yml`. Present in Kubespray
