---
id: VARIABLE-KUBE_OVN_NODE_MEMORY_LIMIT
type: variable
title: kube_ovn_node_memory_limit
status: active
...
Kubespray variable `kube_ovn_node_memory_limit` — default `800Mi`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
