---
id: VARIABLE-NVIDIA_ACCELERATOR_ENABLED
type: variable
title: nvidia_accelerator_enabled
status: active
...
Kubespray variable `nvidia_accelerator_enabled` — default `false`. Defined in `roles/kubernetes-apps/container_engine_accelerator/nvidia_gpu/defaults/main.yml`. Present in Kubespray
