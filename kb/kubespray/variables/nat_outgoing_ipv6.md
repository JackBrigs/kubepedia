---
id: VARIABLE-NAT_OUTGOING_IPV6
type: variable
title: nat_outgoing_ipv6
status: active
...
Kubespray variable `nat_outgoing_ipv6` — default `false`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
