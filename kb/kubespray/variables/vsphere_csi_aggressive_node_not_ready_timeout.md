---
id: VARIABLE-VSPHERE_CSI_AGGRESSIVE_NODE_NOT_READY_TIMEOUT
type: variable
title: vsphere_csi_aggressive_node_not_ready_timeout
status: active
...
confidence: verified
aliases:
  - vsphere_csi_aggressive_node_not_ready_timeout
tags:
  - kubernetes-apps
  - csi-driver
  - variable
...
Kubespray variable `vsphere_csi_aggressive_node_not_ready_timeout` — default `300`. Defined in `roles/kubernetes-apps/csi_driver/vsphere/defaults/main.yml`. Present in Kubespray
