---
id: VARIABLE-KUBE_OVN_ENABLE_SSL
type: variable
title: kube_ovn_enable_ssl
status: active
...
Kubespray variable `kube_ovn_enable_ssl` — default `false`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
