---
id: VARIABLE-CRIO_REMAP_ENABLE
type: variable
title: crio_remap_enable
status: active
...
Kubespray variable `crio_remap_enable` — default `false`. Defined in `roles/container-engine/cri-o/defaults/main.yml`. Present in Kubespray
