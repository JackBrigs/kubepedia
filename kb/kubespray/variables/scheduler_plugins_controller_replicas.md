---
id: VARIABLE-SCHEDULER_PLUGINS_CONTROLLER_REPLICAS
type: variable
title: scheduler_plugins_controller_replicas
status: active
...
confidence: verified
aliases:
  - scheduler_plugins_controller_replicas
tags:
  - kubernetes-apps
  - scheduler-plugins
  - variable
...
Kubespray variable `scheduler_plugins_controller_replicas` — default `1`. Defined in `roles/kubernetes-apps/scheduler_plugins/defaults/main.yml`. Present in Kubespray
