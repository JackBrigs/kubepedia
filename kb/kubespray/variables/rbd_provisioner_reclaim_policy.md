---
id: VARIABLE-RBD_PROVISIONER_RECLAIM_POLICY
type: variable
title: rbd_provisioner_reclaim_policy
status: active
...
confidence: verified
aliases:
  - rbd_provisioner_reclaim_policy
tags:
  - kubernetes-apps
...
Kubespray variable `rbd_provisioner_reclaim_policy` — default `Delete`. Defined in `roles/kubernetes-apps/external_provisioner/rbd_provisioner/defaults/main.yml`. Present in Kubespray
