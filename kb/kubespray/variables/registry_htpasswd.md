---
id: VARIABLE-REGISTRY_HTPASSWD
type: variable
title: registry_htpasswd
status: active
...
Kubespray variable `registry_htpasswd` — default `(empty)`. Defined in `roles/kubernetes-apps/registry/defaults/main.yml`. Present in Kubespray
