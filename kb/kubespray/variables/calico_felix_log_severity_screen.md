---
id: VARIABLE-CALICO_FELIX_LOG_SEVERITY_SCREEN
type: variable
title: calico_felix_log_severity_screen
status: active
...
confidence: verified
aliases:
  - calico_felix_log_severity_screen
tags:
  - network-plugin
  - calico-defaults
  - variable
...
Kubespray variable `calico_felix_log_severity_screen` — default `Info`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
