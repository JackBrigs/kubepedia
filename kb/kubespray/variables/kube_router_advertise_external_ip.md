---
id: VARIABLE-KUBE_ROUTER_ADVERTISE_EXTERNAL_IP
type: variable
title: kube_router_advertise_external_ip
status: active
...
Kubespray variable `kube_router_advertise_external_ip` — default `false`. Defined in `roles/network_plugin/kube-router/defaults/main.yml`. Present in Kubespray
