---
id: VARIABLE-CINDER_USERNAME
type: variable
title: cinder_username
status: active
...
Kubespray variable `cinder_username` — default `{{ lookup('env', 'OS_USERNAME') }}`. Defined in `roles/kubernetes-apps/csi_driver/cinder/defaults/main.yml`. Present in Kubespray
