---
id: VARIABLE-CALICO_ADVERTISE_SERVICE_EXTERNAL_IPS
type: variable
title: calico_advertise_service_external_ips
status: active
...
Kubespray variable `calico_advertise_service_external_ips` — default `[]`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
