---
id: VARIABLE-KUBE_OVN_IC_DBHOST
type: variable
title: kube_ovn_ic_dbhost
status: active
...
Kubespray variable `kube_ovn_ic_dbhost` — default `127.0.0.1`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
