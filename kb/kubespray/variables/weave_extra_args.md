---
id: VARIABLE-WEAVE_EXTRA_ARGS
type: variable
title: weave_extra_args
status: active
...
Kubespray variable `weave_extra_args` — default `~`. Defined in `roles/network_plugin/weave/defaults/main.yml`. Present in Kubespray
