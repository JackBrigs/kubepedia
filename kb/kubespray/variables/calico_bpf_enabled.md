---
id: VARIABLE-CALICO_BPF_ENABLED
type: variable
title: calico_bpf_enabled
status: active
...
Kubespray variable `calico_bpf_enabled` — default `false`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
