---
id: VARIABLE-CALICO_CNI_LOG_FILE_PATH
type: variable
title: calico_cni_log_file_path
status: active
...
sources:
  - type: code
    ...
    note: "default: /var/log/calico/cni/cni.log"
relations: []
---
...
Kubespray variable `calico_cni_log_file_path` — default `/var/log/calico/cni/cni.log`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
