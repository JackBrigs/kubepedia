---
id: VARIABLE-EXTERNAL_OPENSTACK_DOMAIN_NAME
type: variable
title: external_openstack_domain_name
status: active
...
confidence: verified
aliases:
  - external_openstack_domain_name
tags:
  - kubernetes-apps
...
sources:
  - type: code
    ...
    note: "default: {{ lookup('env', 'OS_USER_DOMAIN_NAME') }}"
relations: []
---
...
Kubespray variable `external_openstack_domain_name` — default `{{ lookup('env', 'OS_USER_DOMAIN_NAME') }}`. Defined in `roles/kubernetes-apps/external_cloud_controller/openstack/defaults/main.yml`. Present in Kubespray
