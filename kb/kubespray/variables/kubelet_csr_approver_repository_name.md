---
id: VARIABLE-KUBELET_CSR_APPROVER_REPOSITORY_NAME
type: variable
title: kubelet_csr_approver_repository_name
status: active
...
confidence: verified
aliases:
  - kubelet_csr_approver_repository_name
tags:
  - kubernetes-apps
...
sources:
  - type: code
    ...
    note: "default: kubelet-csr-approver"
relations: []
---
...
Kubespray variable `kubelet_csr_approver_repository_name` — default `kubelet-csr-approver`. Defined in `roles/kubernetes-apps/kubelet-csr-approver/defaults/main.yml`. Present in Kubespray
