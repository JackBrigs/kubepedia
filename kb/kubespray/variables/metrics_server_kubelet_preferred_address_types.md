---
id: VARIABLE-METRICS_SERVER_KUBELET_PREFERRED_ADDRESS_TYPES
type: variable
title: metrics_server_kubelet_preferred_address_types
status: active
...
sources:
  - type: code
    ...
    note: "default: InternalIP,ExternalIP,Hostname"
relations: []
---
...
Kubespray variable `metrics_server_kubelet_preferred_address_types` — default `InternalIP,ExternalIP,Hostname`. Defined in `roles/kubernetes-apps/metrics_server/defaults/main.yml`. Present in Kubespray
