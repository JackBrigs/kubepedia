---
id: VARIABLE-KUBE_OVN_BIND_LOCAL_IP_ENABLED
type: variable
title: kube_ovn_bind_local_ip_enabled
status: active
...
confidence: verified
aliases:
  - kube_ovn_bind_local_ip_enabled
tags:
  - network-plugin
  - kube-ovn
  - variable
...
Kubespray variable `kube_ovn_bind_local_ip_enabled` — default `true`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
