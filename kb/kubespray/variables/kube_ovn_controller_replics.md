---
id: VARIABLE-KUBE_OVN_CONTROLLER_REPLICS
type: variable
title: kube_ovn_controller_replics
status: active
...
Kubespray variable `kube_ovn_controller_replics` — default `{{ kube_ovn_central_hosts | length }}`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
