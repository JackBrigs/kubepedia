---
id: VARIABLE-KUBE_ROUTER_METRICS_PORT
type: variable
title: kube_router_metrics_port
status: active
...
Kubespray variable `kube_router_metrics_port` — default `9255`. Defined in `roles/network_plugin/kube-router/defaults/main.yml`. Present in Kubespray
