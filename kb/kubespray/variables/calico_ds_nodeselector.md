---
id: VARIABLE-CALICO_DS_NODESELECTOR
type: variable
title: calico_ds_nodeselector
status: active
...
Kubespray variable `calico_ds_nodeselector` — default `kubernetes.io/os: linux`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
