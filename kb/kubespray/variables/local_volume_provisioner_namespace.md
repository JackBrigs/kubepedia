---
id: VARIABLE-LOCAL_VOLUME_PROVISIONER_NAMESPACE
type: variable
title: local_volume_provisioner_namespace
status: active
...
Kubespray variable `local_volume_provisioner_namespace` — default `kube-system`. Defined in `roles/kubernetes-apps/external_provisioner/local_volume_provisioner/defaults/main.yml`. Present in Kubespray
