---
id: VARIABLE-CEPHFS_PROVISIONER_STORAGE_CLASS
type: variable
title: cephfs_provisioner_storage_class
status: active
...
confidence: verified
aliases:
  - cephfs_provisioner_storage_class
tags:
  - kubernetes-apps
...
Kubespray variable `cephfs_provisioner_storage_class` — default `cephfs`. Defined in `roles/kubernetes-apps/external_provisioner/cephfs_provisioner/defaults/main.yml`. Present in Kubespray
