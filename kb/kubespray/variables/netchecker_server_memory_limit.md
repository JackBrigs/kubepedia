---
id: VARIABLE-NETCHECKER_SERVER_MEMORY_LIMIT
type: variable
title: netchecker_server_memory_limit
status: active
...
confidence: verified
aliases:
  - netchecker_server_memory_limit
tags:
  - kubernetes-apps
  - ansible
  - variable
...
Kubespray variable `netchecker_server_memory_limit` — default `256M`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
