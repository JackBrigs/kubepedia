---
id: VARIABLE-KUBE_OVN_DEFAULT_LOGICAL_GATEWAY
type: variable
title: kube_ovn_default_logical_gateway
status: active
...
Kubespray variable `kube_ovn_default_logical_gateway` — default `false`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
