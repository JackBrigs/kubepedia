---
id: VARIABLE-ENABLE_COREDNS_REVERSE_DNS_LOOKUPS
type: variable
title: enable_coredns_reverse_dns_lookups
status: active
...
Kubespray variable `enable_coredns_reverse_dns_lookups` — default `true`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
