---
id: VARIABLE-NODE_FEATURE_DISCOVERY_GC_SA_CREATE
type: variable
title: node_feature_discovery_gc_sa_create
status: active
...
Kubespray variable `node_feature_discovery_gc_sa_create` — default `true`. Defined in `roles/kubernetes-apps/node_feature_discovery/defaults/main.yml`. Present in Kubespray
