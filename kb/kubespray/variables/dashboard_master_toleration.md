---
id: VARIABLE-DASHBOARD_MASTER_TOLERATION
type: variable
title: dashboard_master_toleration
status: active
...
Kubespray variable `dashboard_master_toleration` — default `true`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
