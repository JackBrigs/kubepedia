---
id: VARIABLE-KUBE_ROUTER_RUN_ROUTER
type: variable
title: kube_router_run_router
status: active
...
Kubespray variable `kube_router_run_router` — default `true`. Defined in `roles/network_plugin/kube-router/defaults/main.yml`. Present in Kubespray
