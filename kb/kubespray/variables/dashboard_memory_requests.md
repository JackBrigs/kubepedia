---
id: VARIABLE-DASHBOARD_MEMORY_REQUESTS
type: variable
title: dashboard_memory_requests
status: active
...
Kubespray variable `dashboard_memory_requests` — default `64M`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
