---
id: VARIABLE-EXTERNAL_OPENSTACK_PASSWORD
type: variable
title: external_openstack_password
status: active
...
Kubespray variable `external_openstack_password` — default `{{ lookup('env', 'OS_PASSWORD') }}`. Defined in `roles/kubernetes-apps/external_cloud_controller/openstack/defaults/main.yml`. Present in Kubespray
