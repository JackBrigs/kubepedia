---
id: VARIABLE-DNS_MEMORY_REQUESTS
type: variable
title: dns_memory_requests
status: active
...
Kubespray variable `dns_memory_requests` — default `70Mi`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
