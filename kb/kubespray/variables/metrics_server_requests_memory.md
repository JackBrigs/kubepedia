---
id: VARIABLE-METRICS_SERVER_REQUESTS_MEMORY
type: variable
title: metrics_server_requests_memory
status: active
...
Kubespray variable `metrics_server_requests_memory` — default `200Mi`. Defined in `roles/kubernetes-apps/metrics_server/defaults/main.yml`. Present in Kubespray
