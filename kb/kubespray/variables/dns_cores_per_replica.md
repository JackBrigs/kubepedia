---
id: VARIABLE-DNS_CORES_PER_REPLICA
type: variable
title: dns_cores_per_replica
status: active
...
Kubespray variable `dns_cores_per_replica` — default `256`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
