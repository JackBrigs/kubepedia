---
id: VARIABLE-KUBE_OVN_DB_CPU_REQUEST
type: variable
title: kube_ovn_db_cpu_request
status: active
...
Kubespray variable `kube_ovn_db_cpu_request` — default `500m`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
