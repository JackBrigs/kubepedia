---
id: VARIABLE-KUBELET_CSR_APPROVER_ENABLED
type: variable
title: kubelet_csr_approver_enabled
status: active
...
sources:
  - type: code
    ...
    note: "default: {{ kubelet_rotate_server_certificates }}"
relations: []
---
...
Kubespray variable `kubelet_csr_approver_enabled` — default `{{ kubelet_rotate_server_certificates }}`. Defined in `roles/kubernetes-apps/kubelet-csr-approver/defaults/main.yml`. Present in Kubespray
