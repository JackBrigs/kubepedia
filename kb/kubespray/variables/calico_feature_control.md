---
id: VARIABLE-CALICO_FEATURE_CONTROL
type: variable
title: calico_feature_control
status: active
...
Kubespray variable `calico_feature_control` — default `{}`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
