---
id: VARIABLE-MULTUS_NAMESPACE_ISOLATION
type: variable
title: multus_namespace_isolation
status: active
...
Kubespray variable `multus_namespace_isolation` — default `false`. Defined in `roles/network_plugin/multus/defaults/main.yml`. Present in Kubespray
