---
id: VARIABLE-CERT_MANAGER_NO_PROXY
type: variable
title: cert_manager_no_proxy
status: active
...
Kubespray variable `cert_manager_no_proxy` — default `{{ no_proxy | default('') }}`. Defined in `roles/kubernetes-apps/ingress_controller/cert_manager/defaults/main.yml`. Present in Kubespray
