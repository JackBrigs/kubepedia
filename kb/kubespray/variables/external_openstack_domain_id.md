---
id: VARIABLE-EXTERNAL_OPENSTACK_DOMAIN_ID
type: variable
title: external_openstack_domain_id
status: active
...
Kubespray variable `external_openstack_domain_id` — default `{{ lookup('env', 'OS_USER_DOMAIN_ID') }}`. Defined in `roles/kubernetes-apps/external_cloud_controller/openstack/defaults/main.yml`. Present in Kubespray
