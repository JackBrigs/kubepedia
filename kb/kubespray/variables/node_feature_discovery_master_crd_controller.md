---
id: VARIABLE-NODE_FEATURE_DISCOVERY_MASTER_CRD_CONTROLLER
type: variable
title: node_feature_discovery_master_crd_controller
status: active
...
Kubespray variable `node_feature_discovery_master_crd_controller` — default `null`. Defined in `roles/kubernetes-apps/node_feature_discovery/defaults/main.yml`. Present in Kubespray
