---
id: VARIABLE-METALLB_CONTROLLER_NODESELECTOR
type: variable
title: metallb_controller_nodeselector
status: active
...
Kubespray variable `metallb_controller_nodeselector` — default `(structured / block value — see source)`. Defined in `roles/kubernetes-apps/metallb/defaults/main.yml`. Present in Kubespray
...
```yaml
metallb_controller_nodeselector: (structured / block value — see source)
```
