---
id: VARIABLE-CALICO_IPAM_AUTOALLOCATEBLOCKS
type: variable
title: calico_ipam_autoallocateblocks
status: active
...
Kubespray variable `calico_ipam_autoallocateblocks` — default `true`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
