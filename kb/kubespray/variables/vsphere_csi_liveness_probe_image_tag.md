---
id: VARIABLE-VSPHERE_CSI_LIVENESS_PROBE_IMAGE_TAG
type: variable
title: vsphere_csi_liveness_probe_image_tag
status: active
...
confidence: verified
aliases:
  - vsphere_csi_liveness_probe_image_tag
tags:
  - kubernetes-apps
  - csi-driver
  - variable
...
Kubespray variable `vsphere_csi_liveness_probe_image_tag` — default `v2.10.0`. Defined in `roles/kubernetes-apps/csi_driver/vsphere/defaults/main.yml`. Present in Kubespray
