---
id: VARIABLE-POPULATE_INVENTORY_TO_HOSTS_FILE
type: variable
title: populate_inventory_to_hosts_file
status: active
...
Kubespray variable `populate_inventory_to_hosts_file` — default `true`. Defined in `roles/kubernetes/preinstall/defaults/main.yml`. Present in Kubespray
