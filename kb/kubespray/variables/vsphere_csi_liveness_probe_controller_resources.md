---
id: VARIABLE-VSPHERE_CSI_LIVENESS_PROBE_CONTROLLER_RESOURCES
type: variable
title: vsphere_csi_liveness_probe_controller_resources
status: active
...
Kubespray variable `vsphere_csi_liveness_probe_controller_resources` — default `{}`. Defined in `roles/kubernetes-apps/csi_driver/vsphere/defaults/main.yml`. Present in Kubespray
