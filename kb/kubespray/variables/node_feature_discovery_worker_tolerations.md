---
id: VARIABLE-NODE_FEATURE_DISCOVERY_WORKER_TOLERATIONS
type: variable
title: node_feature_discovery_worker_tolerations
status: active
...
confidence: verified
aliases:
  - node_feature_discovery_worker_tolerations
tags:
  - kubernetes-apps
...
Kubespray variable `node_feature_discovery_worker_tolerations` — default `null`. Defined in `roles/kubernetes-apps/node_feature_discovery/defaults/main.yml`. Present in Kubespray
