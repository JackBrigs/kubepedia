---
id: VARIABLE-CALICO_FELIX_PROMETHEUSMETRICSENABLED
type: variable
title: calico_felix_prometheusmetricsenabled
status: active
...
Kubespray variable `calico_felix_prometheusmetricsenabled` — default `false`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
