---
id: VARIABLE-RBD_PROVISIONER_MONITORS
type: variable
title: rbd_provisioner_monitors
status: active
...
Kubespray variable `rbd_provisioner_monitors` — default `~`. Defined in `roles/kubernetes-apps/external_provisioner/rbd_provisioner/defaults/main.yml`. Present in Kubespray
