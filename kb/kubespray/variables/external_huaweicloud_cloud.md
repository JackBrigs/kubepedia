---
id: VARIABLE-EXTERNAL_HUAWEICLOUD_CLOUD
type: variable
title: external_huaweicloud_cloud
status: active
...
sources:
  - type: code
    ...
    note: "default: {{ lookup('env', 'OS_CLOUD') }}"
relations: []
---
...
Kubespray variable `external_huaweicloud_cloud` — default `{{ lookup('env', 'OS_CLOUD') }}`. Defined in `roles/kubernetes-apps/external_cloud_controller/huaweicloud/defaults/main.yml`. Present in Kubespray
