---
id: VARIABLE-NETCHECKER_AGENT_GROUP
type: variable
title: netchecker_agent_group
status: active
...
Kubespray variable `netchecker_agent_group` — default `1000`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
