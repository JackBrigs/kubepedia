---
id: VARIABLE-CEPHFS_PROVISIONER_DETERMINISTIC_NAMES
type: variable
title: cephfs_provisioner_deterministic_names
status: active
...
confidence: verified
aliases:
  - cephfs_provisioner_deterministic_names
tags:
  - kubernetes-apps
...
Kubespray variable `cephfs_provisioner_deterministic_names` — default `true`. Defined in `roles/kubernetes-apps/external_provisioner/cephfs_provisioner/defaults/main.yml`. Present in Kubespray
