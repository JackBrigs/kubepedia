---
id: VARIABLE-LOCAL_VOLUME_PROVISIONER_LOG_LEVEL
type: variable
title: local_volume_provisioner_log_level
status: active
...
confidence: verified
aliases:
  - local_volume_provisioner_log_level
tags:
  - kubernetes-apps
...
Kubespray variable `local_volume_provisioner_log_level` — default `2`. Defined in `roles/kubernetes-apps/external_provisioner/local_volume_provisioner/defaults/main.yml`. Present in Kubespray
