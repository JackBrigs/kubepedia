---
id: VARIABLE-CERT_MANAGER_HTTPS_PROXY
type: variable
title: cert_manager_https_proxy
status: active
...
sources:
  - type: code
    ...
    note: "default: {{ https_proxy | default('') }}"
relations: []
---
...
Kubespray variable `cert_manager_https_proxy` — default `{{ https_proxy | default('') }}`. Defined in `roles/kubernetes-apps/ingress_controller/cert_manager/defaults/main.yml`. Present in Kubespray
