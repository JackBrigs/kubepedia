---
id: VARIABLE-WEAVE_KUBE_PEERS
type: variable
title: weave_kube_peers
status: active
...
Kubespray variable `weave_kube_peers` — default `~`. Defined in `roles/network_plugin/weave/defaults/main.yml`. Present in Kubespray
