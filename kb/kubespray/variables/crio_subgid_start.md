---
id: VARIABLE-CRIO_SUBGID_START
type: variable
title: crio_subgid_start
status: active
...
Kubespray variable `crio_subgid_start` — default `2130706432`. Defined in `roles/container-engine/cri-o/defaults/main.yml`. Present in Kubespray
