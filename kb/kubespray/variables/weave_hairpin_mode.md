---
id: VARIABLE-WEAVE_HAIRPIN_MODE
type: variable
title: weave_hairpin_mode
status: active
...
Kubespray variable `weave_hairpin_mode` — default `true`. Defined in `roles/network_plugin/weave/defaults/main.yml`. Present in Kubespray
