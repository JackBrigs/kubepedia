---
id: VARIABLE-INGRESS_NGINX_ENABLED
type: variable
title: ingress_nginx_enabled
status: active
...
Kubespray variable `ingress_nginx_enabled` — default `false`. Defined in `roles/kubespray_defaults/defaults/main/main.yml`. Present in Kubespray
