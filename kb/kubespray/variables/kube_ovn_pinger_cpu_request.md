---
id: VARIABLE-KUBE_OVN_PINGER_CPU_REQUEST
type: variable
title: kube_ovn_pinger_cpu_request
status: active
...
Kubespray variable `kube_ovn_pinger_cpu_request` — default `100m`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
