---
id: VARIABLE-NVIDIA_DRIVER_INSTALL_CONTAINER
type: variable
title: nvidia_driver_install_container
status: active
...
Kubespray variable `nvidia_driver_install_container` — default `false`. Defined in `roles/kubernetes-apps/container_engine_accelerator/nvidia_gpu/defaults/main.yml`. Present in Kubespray
