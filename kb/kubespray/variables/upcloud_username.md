---
id: VARIABLE-UPCLOUD_USERNAME
type: variable
title: upcloud_username
status: active
...
sources:
  - type: code
    ...
    note: "default: {{ lookup('env', 'UPCLOUD_USERNAME') }}"
relations: []
---
...
Kubespray variable `upcloud_username` — default `{{ lookup('env', 'UPCLOUD_USERNAME') }}`. Defined in `roles/kubernetes-apps/csi_driver/upcloud/defaults/main.yml`. Present in Kubespray
