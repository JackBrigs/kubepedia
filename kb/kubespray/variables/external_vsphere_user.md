---
id: VARIABLE-EXTERNAL_VSPHERE_USER
type: variable
title: external_vsphere_user
status: active
...
sources:
  - type: code
    ...
    note: "default: {{ lookup('env', 'VSPHERE_USER') }}"
relations: []
---
...
Kubespray variable `external_vsphere_user` — default `{{ lookup('env', 'VSPHERE_USER') }}`. Defined in `roles/kubernetes-apps/csi_driver/vsphere/defaults/main.yml`. Present in Kubespray
