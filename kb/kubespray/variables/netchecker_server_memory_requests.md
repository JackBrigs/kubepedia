---
id: VARIABLE-NETCHECKER_SERVER_MEMORY_REQUESTS
type: variable
title: netchecker_server_memory_requests
status: active
...
confidence: verified
aliases:
  - netchecker_server_memory_requests
tags:
  - kubernetes-apps
  - ansible
  - variable
...
Kubespray variable `netchecker_server_memory_requests` — default `64M`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
