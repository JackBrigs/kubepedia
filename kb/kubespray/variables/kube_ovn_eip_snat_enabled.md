---
id: VARIABLE-KUBE_OVN_EIP_SNAT_ENABLED
type: variable
title: kube_ovn_eip_snat_enabled
status: active
...
Kubespray variable `kube_ovn_eip_snat_enabled` — default `true`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
