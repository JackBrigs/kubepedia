---
id: VARIABLE-COREDNS_ORDINAL_SUFFIX
type: variable
title: coredns_ordinal_suffix
status: active
...
Kubespray variable `coredns_ordinal_suffix` — default `(empty)`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
