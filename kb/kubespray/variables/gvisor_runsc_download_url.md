---
id: VARIABLE-GVISOR_RUNSC_DOWNLOAD_URL
type: variable
title: gvisor_runsc_download_url
status: active
...
sources:
  - type: code
    ...
    note: "Computed download URL for the gVisor runsc binary"
relations: []
---
...
## Summary
Download URL for the gVisor `runsc` binary, computed from the Google Storage base URL, the gVisor version, and the node architecture.
