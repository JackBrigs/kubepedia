---
id: VARIABLE-CALICO_CNI_NAME
type: variable
title: calico_cni_name
status: active
...
Kubespray variable `calico_cni_name` — default `k8s-pod-network`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
