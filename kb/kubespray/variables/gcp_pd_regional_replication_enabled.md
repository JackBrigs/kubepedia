---
id: VARIABLE-GCP_PD_REGIONAL_REPLICATION_ENABLED
type: variable
title: gcp_pd_regional_replication_enabled
status: active
...
confidence: verified
aliases:
  - gcp_pd_regional_replication_enabled
tags:
  - kubernetes-apps
  - persistent-volumes
  - variable
...
Kubespray variable `gcp_pd_regional_replication_enabled` — default `false`. Defined in `roles/kubernetes-apps/persistent_volumes/gcp-pd-csi/defaults/main.yml`. Present in Kubespray
