---
id: VARIABLE-FLANNEL_VXLAN_PORT
type: variable
title: flannel_vxlan_port
status: active
...
Kubespray variable `flannel_vxlan_port` — default `8472`. Defined in `roles/network_plugin/flannel/defaults/main.yml`. Present in Kubespray
