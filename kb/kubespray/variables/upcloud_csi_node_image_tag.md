---
id: VARIABLE-UPCLOUD_CSI_NODE_IMAGE_TAG
type: variable
title: upcloud_csi_node_image_tag
status: active
...
Kubespray variable `upcloud_csi_node_image_tag` — default `v2.5.0`. Defined in `roles/kubernetes-apps/csi_driver/upcloud/defaults/main.yml`. Present in Kubespray
