---
id: VARIABLE-UPCLOUD_PASSWORD
type: variable
title: upcloud_password
status: active
...
sources:
  - type: code
    ...
    note: "default: {{ lookup('env', 'UPCLOUD_PASSWORD') }}"
relations: []
---
...
Kubespray variable `upcloud_password` — default `{{ lookup('env', 'UPCLOUD_PASSWORD') }}`. Defined in `roles/kubernetes-apps/csi_driver/upcloud/defaults/main.yml`. Present in Kubespray
