---
id: VARIABLE-CONTAINERD_GRPC_MAX_RECV_MESSAGE_SIZE
type: variable
title: containerd_grpc_max_recv_message_size
status: active
...
## Summary
Sets the maximum gRPC receive message size (in bytes) for the containerd gRPC server. Default is `16777216` (16 MiB).
...
## Compatibility
Kubespray `>=v2.29.0 <=v2.31.0`. Related: `containerd_grpc_max_send_message_size`.
