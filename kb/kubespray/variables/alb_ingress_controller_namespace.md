---
id: VARIABLE-ALB_INGRESS_CONTROLLER_NAMESPACE
type: variable
title: alb_ingress_controller_namespace
status: active
...
Kubespray variable `alb_ingress_controller_namespace` — default `kube-system`. Defined in `roles/kubernetes-apps/ingress_controller/alb_ingress_controller/defaults/main.yml`. Present in Kubespray
