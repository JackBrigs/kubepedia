---
id: VARIABLE-LOCAL_PATH_PROVISIONER_IS_DEFAULT_STORAGECLASS
type: variable
title: local_path_provisioner_is_default_storageclass
status: active
...
Kubespray variable `local_path_provisioner_is_default_storageclass` — default `true`. Defined in `roles/kubernetes-apps/external_provisioner/local_path_provisioner/defaults/main.yml`. Present in Kubespray
