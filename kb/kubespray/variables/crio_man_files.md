---
id: VARIABLE-CRIO_MAN_FILES
type: variable
title: crio_man_files
status: active
...
Kubespray variable `crio_man_files` — default `(structured / block value — see source)`. Defined in `roles/container-engine/cri-o/defaults/main.yml`. Present in Kubespray
...
```yaml
crio_man_files: (structured / block value — see source)
```
