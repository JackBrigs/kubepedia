---
id: VARIABLE-CALICO_WIREGUARD_ENABLED
type: variable
title: calico_wireguard_enabled
status: active
...
Kubespray variable `calico_wireguard_enabled` — default `false`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
