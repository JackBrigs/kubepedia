---
id: VARIABLE-CINDER_DOMAIN_NAME
type: variable
title: cinder_domain_name
status: active
...
Kubespray variable `cinder_domain_name` — default `{{ lookup('env', 'OS_USER_DOMAIN_NAME') }}`. Defined in `roles/kubernetes-apps/csi_driver/cinder/defaults/main.yml`. Present in Kubespray
