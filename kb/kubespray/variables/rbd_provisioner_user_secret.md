---
id: VARIABLE-RBD_PROVISIONER_USER_SECRET
type: variable
title: rbd_provisioner_user_secret
status: active
...
Kubespray variable `rbd_provisioner_user_secret` — default `ceph-key-user`. Defined in `roles/kubernetes-apps/external_provisioner/rbd_provisioner/defaults/main.yml`. Present in Kubespray
