---
id: VARIABLE-EXTERNAL_ORACLE_VCN
type: variable
title: external_oracle_vcn
status: active
...
Kubespray variable `external_oracle_vcn` — default `(empty)`. Defined in `roles/kubernetes-apps/external_cloud_controller/oci/defaults/main.yml`. Present in Kubespray
