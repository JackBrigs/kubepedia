---
id: VARIABLE-CERT_MANAGER_AFFINITY
type: variable
title: cert_manager_affinity
status: active
...
Kubespray variable `cert_manager_affinity` — default `{}`. Defined in `roles/kubernetes-apps/ingress_controller/cert_manager/defaults/main.yml`. Present in Kubespray
