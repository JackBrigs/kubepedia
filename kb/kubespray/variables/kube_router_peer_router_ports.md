---
id: VARIABLE-KUBE_ROUTER_PEER_ROUTER_PORTS
type: variable
title: kube_router_peer_router_ports
status: active
...
Kubespray variable `kube_router_peer_router_ports` — default `~`. Defined in `roles/network_plugin/kube-router/defaults/main.yml`. Present in Kubespray
