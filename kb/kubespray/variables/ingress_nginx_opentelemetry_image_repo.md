---
id: VARIABLE-INGRESS_NGINX_OPENTELEMETRY_IMAGE_REPO
type: variable
title: ingress_nginx_opentelemetry_image_repo
status: active
...
sources:
  - type: code
    ...
    note: "default: {{ kube_image_repo }}/ingress-nginx/opentelemetry"
relations: []
---
...
Kubespray variable `ingress_nginx_opentelemetry_image_repo` — default `{{ kube_image_repo }}/ingress-nginx/opentelemetry`. Defined in `roles/kubespray_defaults/defaults/main/download.yml`. Present in Kubespray
