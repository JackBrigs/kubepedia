---
id: VARIABLE-COREDNS_DEPLOYMENT_NODESELECTOR
type: variable
title: coredns_deployment_nodeselector
status: active
...
Kubespray variable `coredns_deployment_nodeselector` — default `kubernetes.io/os: linux`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
