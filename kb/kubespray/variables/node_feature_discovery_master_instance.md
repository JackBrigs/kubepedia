---
id: VARIABLE-NODE_FEATURE_DISCOVERY_MASTER_INSTANCE
type: variable
title: node_feature_discovery_master_instance
status: active
...
confidence: verified
aliases:
  - node_feature_discovery_master_instance
tags:
  - kubernetes-apps
...
Kubespray variable `node_feature_discovery_master_instance` — default `null`. Defined in `roles/kubernetes-apps/node_feature_discovery/defaults/main.yml`. Present in Kubespray
