---
id: VARIABLE-EXTERNAL_OPENSTACK_CLOUD_CONTROLLER_EXTRA_ARGS
type: variable
title: external_openstack_cloud_controller_extra_args
status: active
...
Kubespray variable `external_openstack_cloud_controller_extra_args` — default `{}`. Defined in `roles/kubernetes-apps/external_cloud_controller/openstack/defaults/main.yml`. Present in Kubespray
