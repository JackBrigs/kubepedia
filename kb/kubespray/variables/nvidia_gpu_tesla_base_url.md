---
id: VARIABLE-NVIDIA_GPU_TESLA_BASE_URL
type: variable
title: nvidia_gpu_tesla_base_url
status: active
...
sources:
  - type: code
    ...
    note: "default: https://us.download.nvidia.com/tesla/"
relations: []
---
...
Kubespray variable `nvidia_gpu_tesla_base_url` — default `https://us.download.nvidia.com/tesla/`. Defined in `roles/kubernetes-apps/container_engine_accelerator/nvidia_gpu/defaults/main.yml`. Present in Kubespray
