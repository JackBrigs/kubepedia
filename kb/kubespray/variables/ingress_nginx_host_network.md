---
id: VARIABLE-INGRESS_NGINX_HOST_NETWORK
type: variable
title: ingress_nginx_host_network
status: active
...
Kubespray variable `ingress_nginx_host_network` — default `false`. Defined in `roles/kubernetes-apps/ingress_controller/ingress_nginx/defaults/main.yml`. Present in Kubespray
