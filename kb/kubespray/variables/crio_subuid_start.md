---
id: VARIABLE-CRIO_SUBUID_START
type: variable
title: crio_subuid_start
status: active
...
Kubespray variable `crio_subuid_start` — default `2130706432`. Defined in `roles/container-engine/cri-o/defaults/main.yml`. Present in Kubespray
