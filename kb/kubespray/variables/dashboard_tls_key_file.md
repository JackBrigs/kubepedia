---
id: VARIABLE-DASHBOARD_TLS_KEY_FILE
type: variable
title: dashboard_tls_key_file
status: active
...
Kubespray variable `dashboard_tls_key_file` — default `dashboard.key`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
