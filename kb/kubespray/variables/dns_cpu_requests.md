---
id: VARIABLE-DNS_CPU_REQUESTS
type: variable
title: dns_cpu_requests
status: active
...
Kubespray variable `dns_cpu_requests` — default `100m`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
