---
id: VARIABLE-METRICS_SERVER_METRIC_RESOLUTION
type: variable
title: metrics_server_metric_resolution
status: active
...
Kubespray variable `metrics_server_metric_resolution` — default `15s`. Defined in `roles/kubernetes-apps/metrics_server/defaults/main.yml`. Present in Kubespray
