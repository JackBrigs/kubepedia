---
id: VARIABLE-CRIO_REMAP_USER
type: variable
title: crio_remap_user
status: active
...
Kubespray variable `crio_remap_user` — default `containers`. Defined in `roles/container-engine/cri-o/defaults/main.yml`. Present in Kubespray
