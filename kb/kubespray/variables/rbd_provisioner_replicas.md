---
id: VARIABLE-RBD_PROVISIONER_REPLICAS
type: variable
title: rbd_provisioner_replicas
status: active
...
Kubespray variable `rbd_provisioner_replicas` — default `2`. Defined in `roles/kubernetes-apps/external_provisioner/rbd_provisioner/defaults/main.yml`. Present in Kubespray
