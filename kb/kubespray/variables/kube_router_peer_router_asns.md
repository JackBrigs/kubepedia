---
id: VARIABLE-KUBE_ROUTER_PEER_ROUTER_ASNS
type: variable
title: kube_router_peer_router_asns
status: active
...
Kubespray variable `kube_router_peer_router_asns` — default `~`. Defined in `roles/network_plugin/kube-router/defaults/main.yml`. Present in Kubespray
