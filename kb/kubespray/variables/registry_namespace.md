---
id: VARIABLE-REGISTRY_NAMESPACE
type: variable
title: registry_namespace
status: active
...
Kubespray variable `registry_namespace` — default `kube-system`. Defined in `roles/kubernetes-apps/registry/defaults/main.yml`. Present in Kubespray
