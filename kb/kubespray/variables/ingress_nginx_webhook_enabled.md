---
id: VARIABLE-INGRESS_NGINX_WEBHOOK_ENABLED
type: variable
title: ingress_nginx_webhook_enabled
status: active
...
Kubespray variable `ingress_nginx_webhook_enabled` — default `false`. Defined in `roles/kubernetes-apps/ingress_controller/ingress_nginx/defaults/main.yml`. Present in Kubespray
