---
id: VARIABLE-KUBE_ROUTER_PEER_ROUTER_IPS
type: variable
title: kube_router_peer_router_ips
status: active
...
Kubespray variable `kube_router_peer_router_ips` — default `~`. Defined in `roles/network_plugin/kube-router/defaults/main.yml`. Present in Kubespray
