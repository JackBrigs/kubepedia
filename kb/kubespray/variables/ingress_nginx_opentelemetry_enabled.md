---
id: VARIABLE-INGRESS_NGINX_OPENTELEMETRY_ENABLED
type: variable
title: ingress_nginx_opentelemetry_enabled
status: active
...
confidence: verified
aliases:
  - ingress_nginx_opentelemetry_enabled
tags:
  - kubernetes-apps
  - ingress-controller
  - variable
...
Kubespray variable `ingress_nginx_opentelemetry_enabled` — default `false`. Defined in `roles/kubernetes-apps/ingress_controller/ingress_nginx/defaults/main.yml`. Present in Kubespray
