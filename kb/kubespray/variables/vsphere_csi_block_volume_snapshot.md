---
id: VARIABLE-VSPHERE_CSI_BLOCK_VOLUME_SNAPSHOT
type: variable
title: vsphere_csi_block_volume_snapshot
status: active
...
Kubespray variable `vsphere_csi_block_volume_snapshot` — default `false`. Defined in `roles/kubernetes-apps/csi_driver/vsphere/defaults/main.yml`. Present in Kubespray
