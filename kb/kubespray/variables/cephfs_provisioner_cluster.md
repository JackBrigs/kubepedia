---
id: VARIABLE-CEPHFS_PROVISIONER_CLUSTER
type: variable
title: cephfs_provisioner_cluster
status: active
...
Kubespray variable `cephfs_provisioner_cluster` — default `ceph`. Defined in `roles/kubernetes-apps/external_provisioner/cephfs_provisioner/defaults/main.yml`. Present in Kubespray
