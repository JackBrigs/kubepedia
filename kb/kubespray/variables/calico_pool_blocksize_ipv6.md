---
id: VARIABLE-CALICO_POOL_BLOCKSIZE_IPV6
type: variable
title: calico_pool_blocksize_ipv6
status: active
...
Kubespray variable `calico_pool_blocksize_ipv6` — default `122`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
