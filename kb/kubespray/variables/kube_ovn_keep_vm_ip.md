---
id: VARIABLE-KUBE_OVN_KEEP_VM_IP
type: variable
title: kube_ovn_keep_vm_ip
status: active
...
Kubespray variable `kube_ovn_keep_vm_ip` — default `true`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
