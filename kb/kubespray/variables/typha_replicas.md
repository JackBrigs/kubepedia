---
id: VARIABLE-TYPHA_REPLICAS
type: variable
title: typha_replicas
status: active
...
Kubespray variable `typha_replicas` — default `1`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
