---
id: VARIABLE-KUBE_OVN_MONITOR_CPU_REQUEST
type: variable
title: kube_ovn_monitor_cpu_request
status: active
...
Kubespray variable `kube_ovn_monitor_cpu_request` — default `200m`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
