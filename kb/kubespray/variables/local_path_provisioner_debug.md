---
id: VARIABLE-LOCAL_PATH_PROVISIONER_DEBUG
type: variable
title: local_path_provisioner_debug
status: active
...
Kubespray variable `local_path_provisioner_debug` — default `false`. Defined in `roles/kubernetes-apps/external_provisioner/local_path_provisioner/defaults/main.yml`. Present in Kubespray
