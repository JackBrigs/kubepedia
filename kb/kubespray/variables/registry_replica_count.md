---
id: VARIABLE-REGISTRY_REPLICA_COUNT
type: variable
title: registry_replica_count
status: active
...
Kubespray variable `registry_replica_count` — default `1`. Defined in `roles/kubernetes-apps/registry/defaults/main.yml`. Present in Kubespray
