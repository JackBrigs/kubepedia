---
id: VARIABLE-KUBE_ROUTER_RUN_SERVICE_PROXY
type: variable
title: kube_router_run_service_proxy
status: active
...
Kubespray variable `kube_router_run_service_proxy` — default `false`. Defined in `roles/network_plugin/kube-router/defaults/main.yml`. Present in Kubespray
