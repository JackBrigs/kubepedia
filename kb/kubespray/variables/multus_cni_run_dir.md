---
id: VARIABLE-MULTUS_CNI_RUN_DIR
type: variable
title: multus_cni_run_dir
status: active
...
sources:
  - type: code
    ...
    note: "default: {{ ('/host', multus_cni_run_dir_host) | join }}"
relations: []
---
...
Kubespray variable `multus_cni_run_dir` — default `{{ ('/host', multus_cni_run_dir_host) | join }}`. Defined in `roles/network_plugin/multus/defaults/main.yml`. Present in Kubespray
