---
id: VARIABLE-CRIO_CGROUP_MANAGER
type: variable
title: crio_cgroup_manager
status: active
...
sources:
  - type: code
    ...
    note: "default: {{ kubelet_cgroup_driver | default('systemd') }}"
relations: []
---
...
Kubespray variable `crio_cgroup_manager` — default `{{ kubelet_cgroup_driver | default('systemd') }}`. Defined in `roles/container-engine/cri-o/defaults/main.yml`. Present in Kubespray
