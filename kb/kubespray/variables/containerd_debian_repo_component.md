---
id: VARIABLE-CONTAINERD_DEBIAN_REPO_COMPONENT
type: variable
title: containerd_debian_repo_component
status: active
...
Kubespray variable `containerd_debian_repo_component` — default `stable`. Defined in `roles/container-engine/containerd-common/defaults/main.yml`. Present in Kubespray
