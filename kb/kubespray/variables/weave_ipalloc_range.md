---
id: VARIABLE-WEAVE_IPALLOC_RANGE
type: variable
title: weave_ipalloc_range
status: active
...
sources:
  - type: code
    ...
    note: "default: {{ kube_pods_subnets }}"
relations: []
---
...
Kubespray variable `weave_ipalloc_range` — default `{{ kube_pods_subnets }}`. Defined in `roles/network_plugin/weave/defaults/main.yml`. Present in Kubespray
