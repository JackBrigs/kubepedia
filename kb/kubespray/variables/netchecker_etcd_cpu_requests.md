---
id: VARIABLE-NETCHECKER_ETCD_CPU_REQUESTS
type: variable
title: netchecker_etcd_cpu_requests
status: active
...
Kubespray variable `netchecker_etcd_cpu_requests` — default `100m`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
