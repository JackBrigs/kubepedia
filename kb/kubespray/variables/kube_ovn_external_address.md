---
id: VARIABLE-KUBE_OVN_EXTERNAL_ADDRESS
type: variable
title: kube_ovn_external_address
status: active
...
Kubespray variable `kube_ovn_external_address` — default `8.8.8.8`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
