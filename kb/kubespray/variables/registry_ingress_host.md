---
id: VARIABLE-REGISTRY_INGRESS_HOST
type: variable
title: registry_ingress_host
status: active
...
Kubespray variable `registry_ingress_host` — default `(empty)`. Defined in `roles/kubernetes-apps/registry/defaults/main.yml`. Present in Kubespray
