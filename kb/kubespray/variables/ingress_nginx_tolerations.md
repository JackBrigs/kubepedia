---
id: VARIABLE-INGRESS_NGINX_TOLERATIONS
type: variable
title: ingress_nginx_tolerations
status: active
...
Kubespray variable `ingress_nginx_tolerations` — default `[]`. Defined in `roles/kubernetes-apps/ingress_controller/ingress_nginx/defaults/main.yml`. Present in Kubespray
