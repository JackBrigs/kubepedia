---
id: VARIABLE-KUBE_OVN_CENTRAL_HOSTS
type: variable
title: kube_ovn_central_hosts
status: active
...
sources:
  - type: code
    ...
    note: "default: {{ groups['kube_control_plane'] }}"
relations: []
---
...
Kubespray variable `kube_ovn_central_hosts` — default `{{ groups['kube_control_plane'] }}`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
