---
id: VARIABLE-VSPHERE_CSI_NODE_DRIVER_REGISTRAR_RESOURCES
type: variable
title: vsphere_csi_node_driver_registrar_resources
status: active
...
Kubespray variable `vsphere_csi_node_driver_registrar_resources` — default `{}`. Defined in `roles/kubernetes-apps/csi_driver/vsphere/defaults/main.yml`. Present in Kubespray
