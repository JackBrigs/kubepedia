---
id: VARIABLE-POPULATE_LOADBALANCER_APISERVER_TO_HOSTS_FILE
type: variable
title: populate_loadbalancer_apiserver_to_hosts_file
status: active
...
Kubespray variable `populate_loadbalancer_apiserver_to_hosts_file` — default `true`. Defined in `roles/kubernetes/preinstall/defaults/main.yml`. Present in Kubespray
