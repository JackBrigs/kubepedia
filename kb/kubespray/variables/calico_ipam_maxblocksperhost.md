---
id: VARIABLE-CALICO_IPAM_MAXBLOCKSPERHOST
type: variable
title: calico_ipam_maxblocksperhost
status: active
...
Kubespray variable `calico_ipam_maxblocksperhost` — default `0`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
