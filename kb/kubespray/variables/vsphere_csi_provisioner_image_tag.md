---
id: VARIABLE-VSPHERE_CSI_PROVISIONER_IMAGE_TAG
type: variable
title: vsphere_csi_provisioner_image_tag
status: active
...
Kubespray variable `vsphere_csi_provisioner_image_tag` — default `v3.5.0`. Defined in `roles/kubernetes-apps/csi_driver/vsphere/defaults/main.yml`. Present in Kubespray
