---
id: VARIABLE-KATA_CONTAINERS_CONFIG_DIR
type: variable
title: kata_containers_config_dir
status: active
...
sources:
  - type: code
    ...
    note: "default: /etc/kata-containers"
relations: []
---
...
Kubespray variable `kata_containers_config_dir` — default `/etc/kata-containers`. Defined in `roles/container-engine/kata-containers/defaults/main.yml`. Present in Kubespray
