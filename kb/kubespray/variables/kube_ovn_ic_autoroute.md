---
id: VARIABLE-KUBE_OVN_IC_AUTOROUTE
type: variable
title: kube_ovn_ic_autoroute
status: active
...
Kubespray variable `kube_ovn_ic_autoroute` — default `true`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
