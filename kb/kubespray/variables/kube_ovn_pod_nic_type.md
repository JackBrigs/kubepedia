---
id: VARIABLE-KUBE_OVN_POD_NIC_TYPE
type: variable
title: kube_ovn_pod_nic_type
status: active
...
Kubespray variable `kube_ovn_pod_nic_type` — default `veth_pair`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
