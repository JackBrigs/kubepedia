---
id: VARIABLE-INGRESS_NGINX_CLASS
type: variable
title: ingress_nginx_class
status: active
...
Kubespray variable `ingress_nginx_class` — default `nginx`. Defined in `roles/kubernetes-apps/ingress_controller/ingress_nginx/defaults/main.yml`. Present in Kubespray
