---
id: VARIABLE-DRAIN_FALLBACK_GRACE_PERIOD
type: variable
title: drain_fallback_grace_period
status: active
...
Kubespray variable `drain_fallback_grace_period` — default `300`. Defined in `roles/upgrade/pre-upgrade/defaults/main.yml`. Present in Kubespray
