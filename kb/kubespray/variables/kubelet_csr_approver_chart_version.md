---
id: VARIABLE-KUBELET_CSR_APPROVER_CHART_VERSION
type: variable
title: kubelet_csr_approver_chart_version
status: active
...
confidence: verified
aliases:
  - kubelet_csr_approver_chart_version
tags:
  - kubernetes-apps
...
Kubespray variable `kubelet_csr_approver_chart_version` — default `1.1.0`. Defined in `roles/kubernetes-apps/kubelet-csr-approver/defaults/main.yml`. Present in Kubespray
