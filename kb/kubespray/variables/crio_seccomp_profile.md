---
id: VARIABLE-CRIO_SECCOMP_PROFILE
type: variable
title: crio_seccomp_profile
status: active
...
Kubespray variable `crio_seccomp_profile` — default `(empty)`. Defined in `roles/container-engine/cri-o/defaults/main.yml`. Present in Kubespray
