---
id: VARIABLE-NODE_FEATURE_DISCOVERY_MASTER_REPLICAS
type: variable
title: node_feature_discovery_master_replicas
status: active
...
confidence: verified
aliases:
  - node_feature_discovery_master_replicas
tags:
  - kubernetes-apps
...
Kubespray variable `node_feature_discovery_master_replicas` — default `1`. Defined in `roles/kubernetes-apps/node_feature_discovery/defaults/main.yml`. Present in Kubespray
