---
id: VARIABLE-CRIO_SUBUID_LENGTH
type: variable
title: crio_subuid_length
status: active
...
Kubespray variable `crio_subuid_length` — default `16777216`. Defined in `roles/container-engine/cri-o/defaults/main.yml`. Present in Kubespray
