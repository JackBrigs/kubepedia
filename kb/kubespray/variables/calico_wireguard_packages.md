---
id: VARIABLE-CALICO_WIREGUARD_PACKAGES
type: variable
title: calico_wireguard_packages
status: active
...
Kubespray variable `calico_wireguard_packages` — default `[]`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
