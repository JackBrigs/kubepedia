---
id: VARIABLE-KUBE_OVN_IC_ENABLE
type: variable
title: kube_ovn_ic_enable
status: active
...
Kubespray variable `kube_ovn_ic_enable` — default `false`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
