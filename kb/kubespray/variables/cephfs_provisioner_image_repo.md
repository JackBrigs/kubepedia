---
id: VARIABLE-CEPHFS_PROVISIONER_IMAGE_REPO
type: variable
title: cephfs_provisioner_image_repo
status: active
...
sources:
  - type: code
    ...
    note: "default: {{ quay_image_repo }}/external_storage/cephfs-provisioner"
relations: []
---
...
Kubespray variable `cephfs_provisioner_image_repo` — default `{{ quay_image_repo }}/external_storage/cephfs-provisioner`. Defined in `roles/kubespray-defaults/defaults/main/download.yml`. Present in Kubespray
