---
id: VARIABLE-VSPHERE_CSI_ATTACHER_IMAGE_TAG
type: variable
title: vsphere_csi_attacher_image_tag
status: active
...
confidence: verified
aliases:
  - vsphere_csi_attacher_image_tag
tags:
  - kubernetes-apps
  - csi-driver
  - variable
...
Kubespray variable `vsphere_csi_attacher_image_tag` — default `v4.3.0`. Defined in `roles/kubernetes-apps/csi_driver/vsphere/defaults/main.yml`. Present in Kubespray
