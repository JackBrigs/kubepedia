---
id: VARIABLE-EXTERNAL_ORACLE_LOAD_BALANCER_SECURITY_LISTS
type: variable
title: external_oracle_load_balancer_security_lists
status: active
...
Kubespray variable `external_oracle_load_balancer_security_lists` — default `{}`. Defined in `roles/kubernetes-apps/external_cloud_controller/oci/defaults/main.yml`. Present in Kubespray
