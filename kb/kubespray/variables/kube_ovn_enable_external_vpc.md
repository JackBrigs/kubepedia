---
id: VARIABLE-KUBE_OVN_ENABLE_EXTERNAL_VPC
type: variable
title: kube_ovn_enable_external_vpc
status: active
...
Kubespray variable `kube_ovn_enable_external_vpc` — default `true`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
