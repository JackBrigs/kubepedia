---
id: VARIABLE-WEAVE_NPC_IMAGE_TAG
type: variable
title: weave_npc_image_tag
status: active
...
Kubespray variable `weave_npc_image_tag` — default `{{ weave_version }}`. Defined in `roles/kubespray_defaults/defaults/main/download.yml`. Present in Kubespray
