---
id: VARIABLE-COREDNS_POD_DISRUPTION_BUDGET
type: variable
title: coredns_pod_disruption_budget
status: active
...
Kubespray variable `coredns_pod_disruption_budget` — default `false`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
