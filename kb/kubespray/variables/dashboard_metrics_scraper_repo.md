---
id: VARIABLE-DASHBOARD_METRICS_SCRAPER_REPO
type: variable
title: dashboard_metrics_scraper_repo
status: active
...
sources:
  - type: code
    ...
    note: "default: {{ docker_image_repo }}/kubernetesui/metrics-scraper"
relations: []
---
...
Kubespray variable `dashboard_metrics_scraper_repo` — default `{{ docker_image_repo }}/kubernetesui/metrics-scraper`. Defined in `roles/kubespray_defaults/defaults/main/download.yml`. Present in Kubespray
