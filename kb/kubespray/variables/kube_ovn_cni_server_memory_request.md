---
id: VARIABLE-KUBE_OVN_CNI_SERVER_MEMORY_REQUEST
type: variable
title: kube_ovn_cni_server_memory_request
status: active
...
confidence: verified
aliases:
  - kube_ovn_cni_server_memory_request
tags:
  - network-plugin
  - kube-ovn
  - variable
...
Kubespray variable `kube_ovn_cni_server_memory_request` — default `200Mi`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
