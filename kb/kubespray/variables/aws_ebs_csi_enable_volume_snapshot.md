---
id: VARIABLE-AWS_EBS_CSI_ENABLE_VOLUME_SNAPSHOT
type: variable
title: aws_ebs_csi_enable_volume_snapshot
status: active
...
confidence: verified
aliases:
  - aws_ebs_csi_enable_volume_snapshot
tags:
  - kubernetes-apps
  - csi-driver
  - variable
...
Kubespray variable `aws_ebs_csi_enable_volume_snapshot` — default `false`. Defined in `roles/kubernetes-apps/csi_driver/aws_ebs/defaults/main.yml`. Present in Kubespray
