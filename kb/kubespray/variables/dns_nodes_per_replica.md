---
id: VARIABLE-DNS_NODES_PER_REPLICA
type: variable
title: dns_nodes_per_replica
status: active
...
Kubespray variable `dns_nodes_per_replica` — default `16`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
