---
id: VARIABLE-CALICO_NODE_MEMORY_LIMIT
type: variable
title: calico_node_memory_limit
status: active
...
Kubespray variable `calico_node_memory_limit` — default `500M`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
