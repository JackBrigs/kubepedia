---
id: VARIABLE-DNS_AUTOSCALER_DEPLOYMENT_NODESELECTOR
type: variable
title: dns_autoscaler_deployment_nodeselector
status: active
...
Kubespray variable `dns_autoscaler_deployment_nodeselector` — default `kubernetes.io/os: linux`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
