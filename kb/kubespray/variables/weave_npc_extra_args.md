---
id: VARIABLE-WEAVE_NPC_EXTRA_ARGS
type: variable
title: weave_npc_extra_args
status: active
...
Kubespray variable `weave_npc_extra_args` — default `~`. Defined in `roles/network_plugin/weave/defaults/main.yml`. Present in Kubespray
