---
id: VARIABLE-RBD_PROVISIONER_IMAGE_FEATURES
type: variable
title: rbd_provisioner_image_features
status: active
...
confidence: verified
aliases:
  - rbd_provisioner_image_features
tags:
  - kubernetes-apps
...
Kubespray variable `rbd_provisioner_image_features` — default `layering`. Defined in `roles/kubernetes-apps/external_provisioner/rbd_provisioner/defaults/main.yml`. Present in Kubespray
