---
id: VARIABLE-CALICO_CNI_POOL
type: variable
title: calico_cni_pool
status: active
...
Kubespray variable `calico_cni_pool` — default `true`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
