---
id: VARIABLE-KUBE_ROUTER_METRICS_PATH
type: variable
title: kube_router_metrics_path
status: active
...
Kubespray variable `kube_router_metrics_path` — default `/metrics`. Defined in `roles/network_plugin/kube-router/defaults/main.yml`. Present in Kubespray
