---
id: VARIABLE-NETCHECKER_AGENT_MEMORY_LIMIT
type: variable
title: netchecker_agent_memory_limit
status: active
...
Kubespray variable `netchecker_agent_memory_limit` — default `100M`. Defined in `roles/kubernetes-apps/ansible/defaults/main.yml`. Present in Kubespray
