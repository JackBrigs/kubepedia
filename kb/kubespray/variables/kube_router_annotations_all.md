---
id: VARIABLE-KUBE_ROUTER_ANNOTATIONS_ALL
type: variable
title: kube_router_annotations_all
status: active
...
Kubespray variable `kube_router_annotations_all` — default `[]`. Defined in `roles/network_plugin/kube-router/defaults/main.yml`. Present in Kubespray
