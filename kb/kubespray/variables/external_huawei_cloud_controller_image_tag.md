---
id: VARIABLE-EXTERNAL_HUAWEI_CLOUD_CONTROLLER_IMAGE_TAG
type: variable
title: external_huawei_cloud_controller_image_tag
status: active
...
confidence: verified
aliases:
  - external_huawei_cloud_controller_image_tag
tags:
  - kubernetes-apps
...
Kubespray variable `external_huawei_cloud_controller_image_tag` — default `v0.26.8`. Defined in `roles/kubernetes-apps/external_cloud_controller/huaweicloud/defaults/main.yml`. Present in Kubespray
