---
id: VARIABLE-KUBE_OVN_EXTERNAL_DNS
type: variable
title: kube_ovn_external_dns
status: active
...
Kubespray variable `kube_ovn_external_dns` — default `alauda.cn`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
