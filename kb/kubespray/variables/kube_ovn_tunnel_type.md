---
id: VARIABLE-KUBE_OVN_TUNNEL_TYPE
type: variable
title: kube_ovn_tunnel_type
status: active
...
Kubespray variable `kube_ovn_tunnel_type` — default `geneve`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
