---
id: VARIABLE-UPGRADE_NODE_ALWAYS_CORDON
type: variable
title: upgrade_node_always_cordon
status: active
...
Kubespray variable `upgrade_node_always_cordon` — default `false`. Defined in `roles/upgrade/pre-upgrade/defaults/main.yml`. Present in Kubespray
