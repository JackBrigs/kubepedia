---
id: VARIABLE-INGRESS_NGINX_SERVICE_TYPE
type: variable
title: ingress_nginx_service_type
status: active
...
Kubespray variable `ingress_nginx_service_type` — default `LoadBalancer`. Defined in `roles/kubernetes-apps/ingress_controller/ingress_nginx/defaults/main.yml`. Present in Kubespray
