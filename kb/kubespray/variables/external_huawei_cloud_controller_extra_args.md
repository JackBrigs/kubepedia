---
id: VARIABLE-EXTERNAL_HUAWEI_CLOUD_CONTROLLER_EXTRA_ARGS
type: variable
title: external_huawei_cloud_controller_extra_args
status: active
...
Kubespray variable `external_huawei_cloud_controller_extra_args` — default `{}`. Defined in `roles/kubernetes-apps/external_cloud_controller/huaweicloud/defaults/main.yml`. Present in Kubespray
