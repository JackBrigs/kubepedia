---
id: VARIABLE-INGRESS_NGINX_NAMESPACE
type: variable
title: ingress_nginx_namespace
status: active
...
Kubespray variable `ingress_nginx_namespace` — default `ingress-nginx`. Defined in `roles/kubernetes-apps/ingress_controller/ingress_nginx/defaults/main.yml`. Present in Kubespray
