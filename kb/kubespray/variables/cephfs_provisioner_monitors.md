---
id: VARIABLE-CEPHFS_PROVISIONER_MONITORS
type: variable
title: cephfs_provisioner_monitors
status: active
...
Kubespray variable `cephfs_provisioner_monitors` — default `~`. Defined in `roles/kubernetes-apps/external_provisioner/cephfs_provisioner/defaults/main.yml`. Present in Kubespray
