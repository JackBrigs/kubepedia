---
id: VARIABLE-RBD_PROVISIONER_USER_SECRET_NAME
type: variable
title: rbd_provisioner_user_secret_name
status: active
...
Kubespray variable `rbd_provisioner_user_secret_name` — default `ceph-secret-user`. Defined in `roles/kubernetes-apps/external_provisioner/rbd_provisioner/defaults/main.yml`. Present in Kubespray
