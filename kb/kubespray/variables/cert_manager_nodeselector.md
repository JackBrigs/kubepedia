---
id: VARIABLE-CERT_MANAGER_NODESELECTOR
type: variable
title: cert_manager_nodeselector
status: active
...
Kubespray variable `cert_manager_nodeselector` — default `{}`. Defined in `roles/kubernetes-apps/ingress_controller/cert_manager/defaults/main.yml`. Present in Kubespray
