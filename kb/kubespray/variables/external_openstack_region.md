---
id: VARIABLE-EXTERNAL_OPENSTACK_REGION
type: variable
title: external_openstack_region
status: active
...
Kubespray variable `external_openstack_region` — default `{{ lookup('env', 'OS_REGION_NAME') }}`. Defined in `roles/kubernetes-apps/external_cloud_controller/openstack/defaults/main.yml`. Present in Kubespray
