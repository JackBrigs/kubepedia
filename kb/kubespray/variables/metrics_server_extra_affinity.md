---
id: VARIABLE-METRICS_SERVER_EXTRA_AFFINITY
type: variable
title: metrics_server_extra_affinity
status: active
...
Kubespray variable `metrics_server_extra_affinity` — default `{}`. Defined in `roles/kubernetes-apps/metrics_server/defaults/main.yml`. Present in Kubespray
