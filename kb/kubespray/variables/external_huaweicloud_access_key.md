---
id: VARIABLE-EXTERNAL_HUAWEICLOUD_ACCESS_KEY
type: variable
title: external_huaweicloud_access_key
status: active
...
confidence: verified
aliases:
  - external_huaweicloud_access_key
tags:
  - kubernetes-apps
...
sources:
  - type: code
    ...
    note: "default: {{ lookup('env', 'OS_ACCESS_KEY') }}"
relations: []
---
...
Kubespray variable `external_huaweicloud_access_key` — default `{{ lookup('env', 'OS_ACCESS_KEY') }}`. Defined in `roles/kubernetes-apps/external_cloud_controller/huaweicloud/defaults/main.yml`. Present in Kubespray
