---
id: VARIABLE-VSPHERE_CSI_RESIZER_RESOURCES
type: variable
title: vsphere_csi_resizer_resources
status: active
...
Kubespray variable `vsphere_csi_resizer_resources` — default `{}`. Defined in `roles/kubernetes-apps/csi_driver/vsphere/defaults/main.yml`. Present in Kubespray
