---
id: VARIABLE-CERT_MANAGER_DNS_POLICY
type: variable
title: cert_manager_dns_policy
status: active
...
Kubespray variable `cert_manager_dns_policy` — default `ClusterFirst`. Defined in `roles/kubernetes-apps/ingress_controller/cert_manager/defaults/main.yml`. Present in Kubespray
