---
id: VARIABLE-CRIO_STREAM_PORT
type: variable
title: crio_stream_port
status: active
...
Kubespray variable `crio_stream_port` — default `10010`. Defined in `roles/container-engine/cri-o/defaults/main.yml`. Present in Kubespray
