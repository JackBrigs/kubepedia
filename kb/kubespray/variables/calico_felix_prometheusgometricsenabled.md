---
id: VARIABLE-CALICO_FELIX_PROMETHEUSGOMETRICSENABLED
type: variable
title: calico_felix_prometheusgometricsenabled
status: active
...
confidence: verified
aliases:
  - calico_felix_prometheusgometricsenabled
tags:
  - network-plugin
  - calico-defaults
  - variable
...
Kubespray variable `calico_felix_prometheusgometricsenabled` — default `true`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
