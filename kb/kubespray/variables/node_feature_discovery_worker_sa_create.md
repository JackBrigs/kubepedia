---
id: VARIABLE-NODE_FEATURE_DISCOVERY_WORKER_SA_CREATE
type: variable
title: node_feature_discovery_worker_sa_create
status: active
...
confidence: verified
aliases:
  - node_feature_discovery_worker_sa_create
tags:
  - kubernetes-apps
...
Kubespray variable `node_feature_discovery_worker_sa_create` — default `true`. Defined in `roles/kubernetes-apps/node_feature_discovery/defaults/main.yml`. Present in Kubespray
