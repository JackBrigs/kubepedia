---
id: VARIABLE-REGISTRY_SERVICE_TYPE
type: variable
title: registry_service_type
status: active
...
Kubespray variable `registry_service_type` — default `ClusterIP`. Defined in `roles/kubernetes-apps/registry/defaults/main.yml`. Present in Kubespray
