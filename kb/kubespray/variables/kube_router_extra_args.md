---
id: VARIABLE-KUBE_ROUTER_EXTRA_ARGS
type: variable
title: kube_router_extra_args
status: active
...
Kubespray variable `kube_router_extra_args` — default `[]`. Defined in `roles/network_plugin/kube-router/defaults/main.yml`. Present in Kubespray
