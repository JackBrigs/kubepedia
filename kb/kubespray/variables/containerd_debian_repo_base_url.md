---
id: VARIABLE-CONTAINERD_DEBIAN_REPO_BASE_URL
type: variable
title: containerd_debian_repo_base_url
status: active
...
confidence: verified
aliases:
  - containerd_debian_repo_base_url
tags:
  - container-engine
  - containerd-common
  - variable
sources:
  - type: code
    ...
    note: "default: https://download.docker.com/linux/debian"
relations: []
---
...
Kubespray variable `containerd_debian_repo_base_url` — default `https://download.docker.com/linux/debian`. Defined in `roles/container-engine/containerd-common/defaults/main.yml`. Present in Kubespray
