---
id: VARIABLE-RBD_PROVISIONER_SECRET_NAME
type: variable
title: rbd_provisioner_secret_name
status: active
...
sources:
  - type: code
    ...
    note: "default: ceph-secret-admin"
relations: []
---
...
Kubespray variable `rbd_provisioner_secret_name` — default `ceph-secret-admin`. Defined in `roles/kubernetes-apps/external_provisioner/rbd_provisioner/defaults/main.yml`. Present in Kubespray
