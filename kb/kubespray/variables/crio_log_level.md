---
id: VARIABLE-CRIO_LOG_LEVEL
type: variable
title: crio_log_level
status: active
...
Kubespray variable `crio_log_level` — default `info`. Defined in `roles/container-engine/cri-o/defaults/main.yml`. Present in Kubespray
