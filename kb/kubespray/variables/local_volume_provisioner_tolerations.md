---
id: VARIABLE-LOCAL_VOLUME_PROVISIONER_TOLERATIONS
type: variable
title: local_volume_provisioner_tolerations
status: active
...
Kubespray variable `local_volume_provisioner_tolerations` — default `[]`. Defined in `roles/kubernetes-apps/external_provisioner/local_volume_provisioner/defaults/main.yml`. Present in Kubespray
