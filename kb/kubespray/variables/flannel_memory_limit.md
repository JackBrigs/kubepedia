---
id: VARIABLE-FLANNEL_MEMORY_LIMIT
type: variable
title: flannel_memory_limit
status: active
...
Kubespray variable `flannel_memory_limit` — default `500M`. Defined in `roles/network_plugin/flannel/defaults/main.yml`. Present in Kubespray
