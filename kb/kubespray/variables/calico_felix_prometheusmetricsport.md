---
id: VARIABLE-CALICO_FELIX_PROMETHEUSMETRICSPORT
type: variable
title: calico_felix_prometheusmetricsport
status: active
...
confidence: verified
aliases:
  - calico_felix_prometheusmetricsport
tags:
  - network-plugin
  - calico-defaults
  - variable
...
Kubespray variable `calico_felix_prometheusmetricsport` — default `9091`. Defined in `roles/network_plugin/calico_defaults/defaults/main.yml`. Present in Kubespray
