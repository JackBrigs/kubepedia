---
id: VARIABLE-DASHBOARD_IMAGE_REPO
type: variable
title: dashboard_image_repo
status: active
...
sources:
  - type: code
    ...
    note: "default: {{ docker_image_repo }}/kubernetesui/dashboard"
relations: []
---
...
Kubespray variable `dashboard_image_repo` — default `{{ docker_image_repo }}/kubernetesui/dashboard`. Defined in `roles/kubespray_defaults/defaults/main/download.yml`. Present in Kubespray
