---
id: VARIABLE-CINDER_APPLICATION_CREDENTIAL_NAME
type: variable
title: cinder_application_credential_name
status: active
...
confidence: verified
aliases:
  - cinder_application_credential_name
tags:
  - kubernetes-apps
  - csi-driver
  - variable
...
Kubespray variable `cinder_application_credential_name` — default `{{ lookup('env', 'OS_APPLICATION_CREDENTIAL_NAME') }}`. Defined in `roles/kubernetes-apps/csi_driver/cinder/defaults/main.yml`. Present in Kubespray
