---
id: VARIABLE-KUBE_OVN_PINGER_CPU_LIMIT
type: variable
title: kube_ovn_pinger_cpu_limit
status: active
...
Kubespray variable `kube_ovn_pinger_cpu_limit` — default `200m`. Defined in `roles/network_plugin/kube-ovn/defaults/main.yml`. Present in Kubespray
