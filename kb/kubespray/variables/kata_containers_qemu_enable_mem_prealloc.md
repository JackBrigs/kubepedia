---
id: VARIABLE-KATA_CONTAINERS_QEMU_ENABLE_MEM_PREALLOC
type: variable
title: kata_containers_qemu_enable_mem_prealloc
status: active
...
confidence: verified
aliases:
  - kata_containers_qemu_enable_mem_prealloc
tags:
  - container-engine
  - kata-containers
  - variable
...
Kubespray variable `kata_containers_qemu_enable_mem_prealloc` — default `false`. Defined in `roles/container-engine/kata-containers/defaults/main.yml`. Present in Kubespray
