---
id: VARIABLE-UPCLOUD_CACERT
type: variable
title: upcloud_cacert
status: active
...
sources:
  - type: code
    ...
    note: "default: {{ lookup('env', 'OS_CACERT') }}"
relations: []
---
...
Kubespray variable `upcloud_cacert` — default `{{ lookup('env', 'OS_CACERT') }}`. Defined in `roles/kubernetes-apps/csi_driver/upcloud/defaults/main.yml`. Present in Kubespray
